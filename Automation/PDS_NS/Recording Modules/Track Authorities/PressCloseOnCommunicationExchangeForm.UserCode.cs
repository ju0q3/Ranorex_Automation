...
{
    public partial class PressCloseOnCommunicationExchangeForm
    {
        ...
        public void PressCloseOnCommunicationExchangeFormFunction(bool waitForClose)
        {
            if (!Authoritiesrepo.Communications_Exchange_Ok_Authority.CloseButtonInfo.Exists(0))
        	{
        		Ranorex.Report.Error("Could not find Close button for Communications Exchange Form");
        		return;
        	}
        	...
        	if (waitForClose)
        	{
        		...
        		{
        			Ranorex.Report.Error("Communication Exchange Form Failed to Close");
        		}
        	}
        	return;
        }
