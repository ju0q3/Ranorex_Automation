...
{
    public partial class PTC_GD_AK01_2 {
        private PTC_GD_AK01HEADER_2 thisHEADER;
        private PTC_GD_AK01CONTENT_2 thisCONTENT;

        public PTC_GD_AK01HEADER_2 HEADER {
            get { return this.thisHEADER; }
            set { this.thisHEADER = value; }
        }

        public PTC_GD_AK01CONTENT_2 CONTENT {
            get { return this.thisCONTENT; }
            set { this.thisCONTENT = value; }
        }

        public static void createGD_AK01_2(
            ...
            PTC_GD_AK01_2 gD_AK01 = new PTC_GD_AK01_2();
            ...
            PTC_GD_AK01CONTENT_2 content = new PTC_GD_AK01CONTENT_2();
            content.ACK_MESSAGE_ID = ack_message_id;
            content.ACK_SEQUENCE_NUMBER = ack_sequence_number;
            content.RESPONSE_CODE = response_code;
            content.TEXT = text;

            gD_AK01.HEADER = header;
            gD_AK01.CONTENT = content;

            GD_AK01_2 ptc_gd_ak01 = gD_AK01.toSerializableObject();
            fs = File.Create(temp+"/temp.request");
            serializer = new XmlSerializer(typeof(GD_AK01_2));
            var writer = new SteXmlTextWriter(fs);
            serializer.Serialize(writer, ptc_gd_ak01);
            fs.Close();

            request = File.ReadAllText(temp+"/temp.request");
            request = gD_AK01.toSteMessageHeader(request);
            System.IO.File.WriteAllText(SteUtils.getOutboundDir()+SteUtils.getFileName(), request);
        }

        public static void createGD_AK01_2Msmq(
            //string header_event_time, 
            //string header_event_time, 
            //string header_message_id, 
            //string header_sequence_number, 
            ...
            GD_AK01_2 ptc_gd_ak01 = gD_AK01.toSerializableObject();
            serializer = new XmlSerializer(typeof(PTC_GD_AK01_2));
            StringWriter writer = new StringWriter();
            serializer.Serialize(writer, ptc_gd_ak01);
            request = gD_AK01.toSteMessageHeader(writer.ToString());
            SteMessageQueue.Instance().Send(request, "PTC_GD-AK01");
        }

        public GD_AK01_2 toSerializableObject() {
            GD_AK01_2 gd_ak01_2 = new GD_AK01_2();
            gd_ak01_2.Items = new object[2];

            GD_AK01HEADER_2 header = new GD_AK01HEADER_2();
            if (this.HEADER != null) {
                if (this.HEADER.HEADER_EVENT_DATE != null) {
                    header.HEADER_EVENT_DATE = new GD_AK01HEADERHEADER_EVENT_DATE_2[1];
                    GD_AK01HEADERHEADER_EVENT_DATE_2 header_event_date = new GD_AK01HEADERHEADER_EVENT_DATE_2();
                ...
                if (this.HEADER.HEADER_EVENT_TIME != null) {
                    header.HEADER_EVENT_TIME = new GD_AK01HEADERHEADER_EVENT_TIME_2[1];
                    GD_AK01HEADERHEADER_EVENT_TIME_2 header_event_time = new GD_AK01HEADERHEADER_EVENT_TIME_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_ID != null) {
                    header.HEADER_MESSAGE_ID = new GD_AK01HEADERHEADER_MESSAGE_ID_2[1];
                    GD_AK01HEADERHEADER_MESSAGE_ID_2 header_message_id = new GD_AK01HEADERHEADER_MESSAGE_ID_2();
                ...
                if (this.HEADER.HEADER_SEQUENCE_NUMBER != null) {
                    header.HEADER_SEQUENCE_NUMBER = new GD_AK01HEADERHEADER_SEQUENCE_NUMBER_2[1];
                    GD_AK01HEADERHEADER_SEQUENCE_NUMBER_2 header_sequence_number = new GD_AK01HEADERHEADER_SEQUENCE_NUMBER_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_VERSION != null) {
                    header.HEADER_MESSAGE_VERSION = new GD_AK01HEADERHEADER_MESSAGE_VERSION_2[1];
                    GD_AK01HEADERHEADER_MESSAGE_VERSION_2 header_message_version = new GD_AK01HEADERHEADER_MESSAGE_VERSION_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_REVISION != null) {
                    header.HEADER_MESSAGE_REVISION = new GD_AK01HEADERHEADER_MESSAGE_REVISION_2[1];
                    GD_AK01HEADERHEADER_MESSAGE_REVISION_2 header_message_revision = new GD_AK01HEADERHEADER_MESSAGE_REVISION_2();
                ...
                if (this.HEADER.HEADER_SOURCE_SYS != null) {
                    header.HEADER_SOURCE_SYS = new GD_AK01HEADERHEADER_SOURCE_SYS_2[1];
                    GD_AK01HEADERHEADER_SOURCE_SYS_2 header_source_sys = new GD_AK01HEADERHEADER_SOURCE_SYS_2();
                ...
                if (this.HEADER.HEADER_DESTINATION_SYS != null) {
                    header.HEADER_DESTINATION_SYS = new GD_AK01HEADERHEADER_DESTINATION_SYS_2[1];
                    GD_AK01HEADERHEADER_DESTINATION_SYS_2 header_destination_sys = new GD_AK01HEADERHEADER_DESTINATION_SYS_2();
                ...
                if (this.HEADER.HEADER_DISTRICT_NAME != null) {
                    header.HEADER_DISTRICT_NAME = new GD_AK01HEADERHEADER_DISTRICT_NAME_2[1];
                    GD_AK01HEADERHEADER_DISTRICT_NAME_2 header_district_name = new GD_AK01HEADERHEADER_DISTRICT_NAME_2();
                ...
                if (this.HEADER.HEADER_DISTRICT_SCAC != null) {
                    header.HEADER_DISTRICT_SCAC = new GD_AK01HEADERHEADER_DISTRICT_SCAC_2[1];
                    GD_AK01HEADERHEADER_DISTRICT_SCAC_2 header_district_scac = new GD_AK01HEADERHEADER_DISTRICT_SCAC_2();
                ...
                if (this.HEADER.HEADER_USER_ID != null) {
                    header.HEADER_USER_ID = new GD_AK01HEADERHEADER_USER_ID_2[1];
                    GD_AK01HEADERHEADER_USER_ID_2 header_user_id = new GD_AK01HEADERHEADER_USER_ID_2();
            ...
            GD_AK01CONTENT_2 content = new GD_AK01CONTENT_2();
            if (this.CONTENT != null) {
                if (this.CONTENT.ACK_MESSAGE_ID != null) {
                    content.ACK_MESSAGE_ID = new GD_AK01CONTENTACK_MESSAGE_ID_2[1];
                    GD_AK01CONTENTACK_MESSAGE_ID_2 ack_message_id = new GD_AK01CONTENTACK_MESSAGE_ID_2();
                ...
                if (this.CONTENT.ACK_SEQUENCE_NUMBER != null) {
                    content.ACK_SEQUENCE_NUMBER = new GD_AK01CONTENTACK_SEQUENCE_NUMBER_2[1];
                    GD_AK01CONTENTACK_SEQUENCE_NUMBER_2 ack_sequence_number = new GD_AK01CONTENTACK_SEQUENCE_NUMBER_2();
                ...
                if (this.CONTENT.RESPONSE_CODE != null) {
                    content.RESPONSE_CODE = new GD_AK01CONTENTRESPONSE_CODE_2[1];
                    GD_AK01CONTENTRESPONSE_CODE_2 response_code = new GD_AK01CONTENTRESPONSE_CODE_2();
                    response_code.Value = this.CONTENT.RESPONSE_CODE;
                    content.RESPONSE_CODE[0] = response_code;
                }

                if (this.CONTENT.TEXT != null) {
                    content.TEXT = new GD_AK01CONTENTTEXT_2[1];
                    GD_AK01CONTENTTEXT_2 text = new GD_AK01CONTENTTEXT_2();
            ...
            gd_ak01_2.Items[0] = header;
            gd_ak01_2.Items[1] = content;
            return gd_ak01_2;
        }
        ...
        public string toSteMessageHeader(string serializedXml) {
            ...
            string header = "PASSTHRUOTC|GD-AK01|";
    ...
    public partial class PTC_GD_AK01HEADER_2 {
    ...
    public partial class PTC_GD_AK01CONTENT_2 {
    ...
    public partial class GD_AK01_2 {
        private object[] itemsField;

        [System.Xml.Serialization.XmlElementAttribute("HEADER", typeof(GD_AK01HEADER_2), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]

        [System.Xml.Serialization.XmlElementAttribute("CONTENT", typeof(GD_AK01CONTENT_2), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01HEADER_2 {
        private GD_AK01HEADERHEADER_EVENT_DATE_2[] HEADER_EVENT_DATEField;
        private GD_AK01HEADERHEADER_EVENT_TIME_2[] HEADER_EVENT_TIMEField;
        private GD_AK01HEADERHEADER_MESSAGE_ID_2[] HEADER_MESSAGE_IDField;
        private GD_AK01HEADERHEADER_SEQUENCE_NUMBER_2[] HEADER_SEQUENCE_NUMBERField;
        private GD_AK01HEADERHEADER_MESSAGE_VERSION_2[] HEADER_MESSAGE_VERSIONField;
        private GD_AK01HEADERHEADER_MESSAGE_REVISION_2[] HEADER_MESSAGE_REVISIONField;
        private GD_AK01HEADERHEADER_SOURCE_SYS_2[] HEADER_SOURCE_SYSField;
        private GD_AK01HEADERHEADER_DESTINATION_SYS_2[] HEADER_DESTINATION_SYSField;
        private GD_AK01HEADERHEADER_DISTRICT_NAME_2[] HEADER_DISTRICT_NAMEField;
        private GD_AK01HEADERHEADER_DISTRICT_SCAC_2[] HEADER_DISTRICT_SCACField;
        private GD_AK01HEADERHEADER_USER_ID_2[] HEADER_USER_IDField;

        [System.Xml.Serialization.XmlElementAttribute("HEADER_EVENT_DATE", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public GD_AK01HEADERHEADER_EVENT_DATE_2[] HEADER_EVENT_DATE {
        ...
        public GD_AK01HEADERHEADER_EVENT_TIME_2[] HEADER_EVENT_TIME {
        ...
        public GD_AK01HEADERHEADER_MESSAGE_ID_2[] HEADER_MESSAGE_ID {
        ...
        public GD_AK01HEADERHEADER_SEQUENCE_NUMBER_2[] HEADER_SEQUENCE_NUMBER {
        ...
        public GD_AK01HEADERHEADER_MESSAGE_VERSION_2[] HEADER_MESSAGE_VERSION {
        ...
        public GD_AK01HEADERHEADER_MESSAGE_REVISION_2[] HEADER_MESSAGE_REVISION {
        ...
        public GD_AK01HEADERHEADER_SOURCE_SYS_2[] HEADER_SOURCE_SYS {
        ...
        public GD_AK01HEADERHEADER_DESTINATION_SYS_2[] HEADER_DESTINATION_SYS {
        ...
        public GD_AK01HEADERHEADER_DISTRICT_NAME_2[] HEADER_DISTRICT_NAME {
        ...
        public GD_AK01HEADERHEADER_DISTRICT_SCAC_2[] HEADER_DISTRICT_SCAC {
        ...
        public GD_AK01HEADERHEADER_USER_ID_2[] HEADER_USER_ID {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01HEADERHEADER_EVENT_DATE_2 {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01HEADERHEADER_EVENT_TIME_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01HEADERHEADER_MESSAGE_ID_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01HEADERHEADER_SEQUENCE_NUMBER_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01HEADERHEADER_MESSAGE_VERSION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01HEADERHEADER_MESSAGE_REVISION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01HEADERHEADER_SOURCE_SYS_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01HEADERHEADER_DESTINATION_SYS_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01HEADERHEADER_DISTRICT_NAME_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01HEADERHEADER_DISTRICT_SCAC_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01HEADERHEADER_USER_ID_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01CONTENT_2 {
        private GD_AK01CONTENTACK_MESSAGE_ID_2[] ACK_MESSAGE_IDField;
        private GD_AK01CONTENTACK_SEQUENCE_NUMBER_2[] ACK_SEQUENCE_NUMBERField;
        private GD_AK01CONTENTRESPONSE_CODE_2[] RESPONSE_CODEField;
        private GD_AK01CONTENTTEXT_2[] TEXTField;

        [System.Xml.Serialization.XmlElementAttribute("ACK_MESSAGE_ID", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public GD_AK01CONTENTACK_MESSAGE_ID_2[] ACK_MESSAGE_ID {
        ...
        public GD_AK01CONTENTACK_SEQUENCE_NUMBER_2[] ACK_SEQUENCE_NUMBER {
        ...
        public GD_AK01CONTENTRESPONSE_CODE_2[] RESPONSE_CODE {
        ...
        public GD_AK01CONTENTTEXT_2[] TEXT {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01CONTENTACK_MESSAGE_ID_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01CONTENTACK_SEQUENCE_NUMBER_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01CONTENTRESPONSE_CODE_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_AK01CONTENTTEXT_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
