...
{
    public partial class PTC_DG_SWCN_7 {
        private PTC_DG_SWCNHEADER_7 thisHEADER;
        private PTC_DG_SWCNCONTENT_7 thisCONTENT;

        public PTC_DG_SWCNHEADER_7 HEADER {
            get { return this.thisHEADER; }
            set { this.thisHEADER = value; }
        }

        public PTC_DG_SWCNCONTENT_7 CONTENT {
            get { return this.thisCONTENT; }
            set { this.thisCONTENT = value; }
        }

        public static PTC_DG_SWCN_7 fromSerializableObject(DG_SWCN_7 message) {
            PTC_DG_SWCN_7 dg_swcn_7 = new PTC_DG_SWCN_7();
            DG_SWCNHEADER_7 header = null;
            DG_SWCNCONTENT_7 content = null;
            if (message.Items.Length == 1) {
                content = (DG_SWCNCONTENT_7) message.Items[0];
            }
            else {
                header = (DG_SWCNHEADER_7) message.Items[0];
                content = (DG_SWCNCONTENT_7) message.Items[1];
            }

            if (header != null) {
                PTC_DG_SWCNHEADER_7 head = new PTC_DG_SWCNHEADER_7();
                ...
                dg_swcn_7.HEADER = head;

            }

            if (content != null) {
                PTC_DG_SWCNCONTENT_7 cont = new PTC_DG_SWCNCONTENT_7();
                dg_swcn_7.CONTENT = cont;
    ...
    public partial class PTC_DG_SWCNHEADER_7 {
    ...
    public partial class PTC_DG_SWCNCONTENT_7 {
    ...
    public partial class DG_SWCN_7 {
        private object[] itemsField;

        [System.Xml.Serialization.XmlElementAttribute("HEADER", typeof(DG_SWCNHEADER_7), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]

        [System.Xml.Serialization.XmlElementAttribute("CONTENT", typeof(DG_SWCNCONTENT_7), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADER_7 {
        private DG_SWCNHEADERHEADER_EVENT_DATE_7[] HEADER_EVENT_DATEField;
        private DG_SWCNHEADERHEADER_EVENT_TIME_7[] HEADER_EVENT_TIMEField;
        private DG_SWCNHEADERHEADER_MESSAGE_ID_7[] HEADER_MESSAGE_IDField;
        private DG_SWCNHEADERHEADER_SEQUENCE_NUMBER_7[] HEADER_SEQUENCE_NUMBERField;
        private DG_SWCNHEADERHEADER_MESSAGE_VERSION_7[] HEADER_MESSAGE_VERSIONField;
        private DG_SWCNHEADERHEADER_MESSAGE_REVISION_7[] HEADER_MESSAGE_REVISIONField;
        private DG_SWCNHEADERHEADER_SOURCE_SYS_7[] HEADER_SOURCE_SYSField;
        private DG_SWCNHEADERHEADER_DESTINATION_SYS_7[] HEADER_DESTINATION_SYSField;
        private DG_SWCNHEADERHEADER_DISTRICT_NAME_7[] HEADER_DISTRICT_NAMEField;
        private DG_SWCNHEADERHEADER_DISTRICT_SCAC_7[] HEADER_DISTRICT_SCACField;
        private DG_SWCNHEADERHEADER_USER_ID_7[] HEADER_USER_IDField;
        private DG_SWCNHEADERHEADER_TRACK_FILE_VERSION_7[] HEADER_TRACK_FILE_VERSIONField;
        private DG_SWCNHEADERHEADER_HTRN_SCAC_7[] HEADER_HTRN_SCACField;
        private DG_SWCNHEADERHEADER_HTRN_SYMBOL_7[] HEADER_HTRN_SYMBOLField;
        private DG_SWCNHEADERHEADER_HTRN_SECTION_7[] HEADER_HTRN_SECTIONField;
        private DG_SWCNHEADERHEADER_HTRN_ORIGIN_DATE_7[] HEADER_HTRN_ORIGIN_DATEField;
        private DG_SWCNHEADERHEADER_HENG_ENGINE_INITIAL_7[] HEADER_HENG_ENGINE_INITIALField;
        private DG_SWCNHEADERHEADER_HENG_ENGINE_NUMBER_7[] HEADER_HENG_ENGINE_NUMBERField;
        private DG_SWCNHEADERHEADER_UID1_TYPE_7[] HEADER_UID1_TYPEField;
        private DG_SWCNHEADERHEADER_UID1_7[] HEADER_UID1Field;
        private DG_SWCNHEADERHEADER_UID2_TYPE_7[] HEADER_UID2_TYPEField;
        private DG_SWCNHEADERHEADER_UID2_7[] HEADER_UID2Field;

        [System.Xml.Serialization.XmlElementAttribute("HEADER_EVENT_DATE", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public DG_SWCNHEADERHEADER_EVENT_DATE_7[] HEADER_EVENT_DATE {
        ...
        public DG_SWCNHEADERHEADER_EVENT_TIME_7[] HEADER_EVENT_TIME {
        ...
        public DG_SWCNHEADERHEADER_MESSAGE_ID_7[] HEADER_MESSAGE_ID {
        ...
        public DG_SWCNHEADERHEADER_SEQUENCE_NUMBER_7[] HEADER_SEQUENCE_NUMBER {
        ...
        public DG_SWCNHEADERHEADER_MESSAGE_VERSION_7[] HEADER_MESSAGE_VERSION {
        ...
        public DG_SWCNHEADERHEADER_MESSAGE_REVISION_7[] HEADER_MESSAGE_REVISION {
        ...
        public DG_SWCNHEADERHEADER_SOURCE_SYS_7[] HEADER_SOURCE_SYS {
        ...
        public DG_SWCNHEADERHEADER_DESTINATION_SYS_7[] HEADER_DESTINATION_SYS {
        ...
        public DG_SWCNHEADERHEADER_DISTRICT_NAME_7[] HEADER_DISTRICT_NAME {
        ...
        public DG_SWCNHEADERHEADER_DISTRICT_SCAC_7[] HEADER_DISTRICT_SCAC {
        ...
        public DG_SWCNHEADERHEADER_USER_ID_7[] HEADER_USER_ID {
        ...
        public DG_SWCNHEADERHEADER_TRACK_FILE_VERSION_7[] HEADER_TRACK_FILE_VERSION {
        ...
        public DG_SWCNHEADERHEADER_HTRN_SCAC_7[] HEADER_HTRN_SCAC {
        ...
        public DG_SWCNHEADERHEADER_HTRN_SYMBOL_7[] HEADER_HTRN_SYMBOL {
        ...
        public DG_SWCNHEADERHEADER_HTRN_SECTION_7[] HEADER_HTRN_SECTION {
        ...
        public DG_SWCNHEADERHEADER_HTRN_ORIGIN_DATE_7[] HEADER_HTRN_ORIGIN_DATE {
        ...
        public DG_SWCNHEADERHEADER_HENG_ENGINE_INITIAL_7[] HEADER_HENG_ENGINE_INITIAL {
        ...
        public DG_SWCNHEADERHEADER_HENG_ENGINE_NUMBER_7[] HEADER_HENG_ENGINE_NUMBER {
        ...
        public DG_SWCNHEADERHEADER_UID1_TYPE_7[] HEADER_UID1_TYPE {
        ...
        public DG_SWCNHEADERHEADER_UID1_7[] HEADER_UID1 {
        ...
        public DG_SWCNHEADERHEADER_UID2_TYPE_7[] HEADER_UID2_TYPE {
        ...
        public DG_SWCNHEADERHEADER_UID2_7[] HEADER_UID2 {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_EVENT_DATE_7 {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_EVENT_TIME_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_MESSAGE_ID_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_SEQUENCE_NUMBER_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_MESSAGE_VERSION_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_MESSAGE_REVISION_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_SOURCE_SYS_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_DESTINATION_SYS_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_DISTRICT_NAME_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_DISTRICT_SCAC_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_USER_ID_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_TRACK_FILE_VERSION_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_HTRN_SCAC_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_HTRN_SYMBOL_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_HTRN_SECTION_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_HTRN_ORIGIN_DATE_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_HENG_ENGINE_INITIAL_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_HENG_ENGINE_NUMBER_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_UID1_TYPE_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_UID1_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_UID2_TYPE_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNHEADERHEADER_UID2_7 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class DG_SWCNCONTENT_7 {
