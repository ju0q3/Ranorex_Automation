...
{
	public partial class PTC_GD_ADSR_7 {
		public PTC_GD_ADSRHEADER_7 HEADER;
		public PTC_GD_ADSRCONTENT_7 CONTENT;
		public string JSONHeader;

		public static void createGD_ADSR_7(
			...
			PTC_GD_ADSR_7 ptc_gd_adsr = buildPTC_GD_ADSR_7(header_event_date, header_event_time, header_sequence_number, header_message_version, header_message_revision, header_source_sys, header_destination_sys, header_district_name, header_district_scac, header_user_id, header_track_file_version, header_htrn_scac, header_htrn_symbol, header_htrn_section, header_htrn_origin_date, header_heng_engine_initial, header_heng_engine_number, header_uid1_type, header_uid1, header_uid2_type, header_uid2, content_track_authority_number, content_action, content_status_code, content_engine_initial, content_engine_number, content_crew_ack_required, content_electronic_ack_requested);
			ptc_gd_adsr.JSONHeader="{  \"CMD\":\"SendTo\",  \"Destination\":\"MQServer\",  \"MSGID\"\":\"GD-ADSR\",  \"Queue\"\":\"Auto\"}";
			
			GD_ADSR_7 gd_adsr = ptc_gd_adsr.toSerializableObject();
			fs = File.Create(temp+"/temp.request");
			serializer = new XmlSerializer(typeof(GD_ADSR_7));
			var writer = new SteXmlTextWriter(fs);
			serializer.Serialize(writer, gd_adsr);
			fs.Close();

			if (hostname == "" || hostname == "Local") {
				string request = File.ReadAllText(temp+"/temp.request");
				request = ptc_gd_adsr.toSteMessageHeader(request, false);
				System.IO.File.WriteAllText(SteUtils.getOutboundDir()+SteUtils.getFileName(), request);
			} else {
				string request = File.ReadAllText(temp+"/temp.request");
				request = ptc_gd_adsr.toSteMessageHeader(request);
				System.IO.File.WriteAllText(SteUtils.getOutboundDir()+SteUtils.getFileName(), request);
				
//				request = ptc_gd_adsr.toSteMessageHeader(request, true);
...
//				}
		...
		public static PTC_GD_ADSR_7 buildPTC_GD_ADSR_7(
			string header_event_date,
			string header_event_time,
			string header_sequence_number,
			string header_message_version,
			...
			PTC_GD_ADSR_7 ptc_gd_adsr = new PTC_GD_ADSR_7();

			PTC_GD_ADSRHEADER_7 header = new PTC_GD_ADSRHEADER_7();
			header.EVENT_DATE = header_event_date;
			header.EVENT_TIME = header_event_time;
			header.MESSAGE_ID = "GD-ADSR";
			...
			PTC_GD_ADSRCONTENT_7 content = new PTC_GD_ADSRCONTENT_7();
			...
			ptc_gd_adsr.HEADER = header;
			ptc_gd_adsr.CONTENT = content;
			return ptc_gd_adsr;
		}

		public GD_ADSR_7 toSerializableObject() {
			GD_ADSR_7 gd_adsr_7 = new GD_ADSR_7();
			gd_adsr_7.Items = new object[2];

			GD_ADSRHEADER_7 header = new GD_ADSRHEADER_7();
			if (this.HEADER != null) {
				if (HEADER.EVENT_DATE != "Null") {
					header.EVENT_DATE = new GD_ADSRHEADER_EVENT_DATE_7[1];
					header.EVENT_DATE[0] = new GD_ADSRHEADER_EVENT_DATE_7();
					header.EVENT_DATE[0].Value = HEADER.EVENT_DATE;
				}

				if (HEADER.EVENT_TIME != "Null") {
					header.EVENT_TIME = new GD_ADSRHEADER_EVENT_TIME_7[1];
					header.EVENT_TIME[0] = new GD_ADSRHEADER_EVENT_TIME_7();
					header.EVENT_TIME[0].Value = HEADER.EVENT_TIME;
				}

				if (HEADER.MESSAGE_ID != "Null") {
					header.MESSAGE_ID = new GD_ADSRHEADER_MESSAGE_ID_7[1];
					header.MESSAGE_ID[0] = new GD_ADSRHEADER_MESSAGE_ID_7();
					header.MESSAGE_ID[0].Value = HEADER.MESSAGE_ID;
				}

				if (HEADER.SEQUENCE_NUMBER != "Null") {
					header.SEQUENCE_NUMBER = new GD_ADSRHEADER_SEQUENCE_NUMBER_7[1];
					header.SEQUENCE_NUMBER[0] = new GD_ADSRHEADER_SEQUENCE_NUMBER_7();
					header.SEQUENCE_NUMBER[0].Value = HEADER.SEQUENCE_NUMBER;
				}

				if (HEADER.MESSAGE_VERSION != "Null") {
					header.MESSAGE_VERSION = new GD_ADSRHEADER_MESSAGE_VERSION_7[1];
					header.MESSAGE_VERSION[0] = new GD_ADSRHEADER_MESSAGE_VERSION_7();
					header.MESSAGE_VERSION[0].Value = HEADER.MESSAGE_VERSION;
				}

				if (HEADER.MESSAGE_REVISION != "Null") {
					header.MESSAGE_REVISION = new GD_ADSRHEADER_MESSAGE_REVISION_7[1];
					header.MESSAGE_REVISION[0] = new GD_ADSRHEADER_MESSAGE_REVISION_7();
					header.MESSAGE_REVISION[0].Value = HEADER.MESSAGE_REVISION;
				}

				if (HEADER.SOURCE_SYS != "Null") {
					header.SOURCE_SYS = new GD_ADSRHEADER_SOURCE_SYS_7[1];
					header.SOURCE_SYS[0] = new GD_ADSRHEADER_SOURCE_SYS_7();
					header.SOURCE_SYS[0].Value = HEADER.SOURCE_SYS;
				}

				if (HEADER.DESTINATION_SYS != "Null") {
					header.DESTINATION_SYS = new GD_ADSRHEADER_DESTINATION_SYS_7[1];
					header.DESTINATION_SYS[0] = new GD_ADSRHEADER_DESTINATION_SYS_7();
					header.DESTINATION_SYS[0].Value = HEADER.DESTINATION_SYS;
				}

				if (HEADER.DISTRICT_NAME != null && HEADER.DISTRICT_NAME != "") {
					header.DISTRICT_NAME = new GD_ADSRHEADER_DISTRICT_NAME_7[1];
					header.DISTRICT_NAME[0] = new GD_ADSRHEADER_DISTRICT_NAME_7();
				...
				if (HEADER.DISTRICT_SCAC != null && HEADER.DISTRICT_SCAC != "") {
					header.DISTRICT_SCAC = new GD_ADSRHEADER_DISTRICT_SCAC_7[1];
					header.DISTRICT_SCAC[0] = new GD_ADSRHEADER_DISTRICT_SCAC_7();
				...
				if (HEADER.USER_ID != null && HEADER.USER_ID != "") {
					header.USER_ID = new GD_ADSRHEADER_USER_ID_7[1];
					header.USER_ID[0] = new GD_ADSRHEADER_USER_ID_7();
				...
				if (HEADER.TRACK_FILE_VERSION != null && HEADER.TRACK_FILE_VERSION != "") {
					header.TRACK_FILE_VERSION = new GD_ADSRHEADER_TRACK_FILE_VERSION_7[1];
					header.TRACK_FILE_VERSION[0] = new GD_ADSRHEADER_TRACK_FILE_VERSION_7();
				...
				if (HEADER.HTRN_SCAC != null && HEADER.HTRN_SCAC != "") {
					header.HTRN_SCAC = new GD_ADSRHEADER_HTRN_SCAC_7[1];
					header.HTRN_SCAC[0] = new GD_ADSRHEADER_HTRN_SCAC_7();
				...
				if (HEADER.HTRN_SYMBOL != null && HEADER.HTRN_SYMBOL != "") {
					header.HTRN_SYMBOL = new GD_ADSRHEADER_HTRN_SYMBOL_7[1];
					header.HTRN_SYMBOL[0] = new GD_ADSRHEADER_HTRN_SYMBOL_7();
				...
				if (HEADER.HTRN_SECTION != null && HEADER.HTRN_SECTION != "") {
					header.HTRN_SECTION = new GD_ADSRHEADER_HTRN_SECTION_7[1];
					header.HTRN_SECTION[0] = new GD_ADSRHEADER_HTRN_SECTION_7();
				...
				if (HEADER.HTRN_ORIGIN_DATE != null && HEADER.HTRN_ORIGIN_DATE != "") {
					header.HTRN_ORIGIN_DATE = new GD_ADSRHEADER_HTRN_ORIGIN_DATE_7[1];
					header.HTRN_ORIGIN_DATE[0] = new GD_ADSRHEADER_HTRN_ORIGIN_DATE_7();
				...
				if (HEADER.HENG_ENGINE_INITIAL != null && HEADER.HENG_ENGINE_INITIAL != "") {
					header.HENG_ENGINE_INITIAL = new GD_ADSRHEADER_HENG_ENGINE_INITIAL_7[1];
					header.HENG_ENGINE_INITIAL[0] = new GD_ADSRHEADER_HENG_ENGINE_INITIAL_7();
				...
				if (HEADER.HENG_ENGINE_NUMBER != null && HEADER.HENG_ENGINE_NUMBER != "") {
					header.HENG_ENGINE_NUMBER = new GD_ADSRHEADER_HENG_ENGINE_NUMBER_7[1];
					header.HENG_ENGINE_NUMBER[0] = new GD_ADSRHEADER_HENG_ENGINE_NUMBER_7();
				...
				if (HEADER.UID1_TYPE != null && HEADER.UID1_TYPE != "") {
					header.UID1_TYPE = new GD_ADSRHEADER_UID1_TYPE_7[1];
					header.UID1_TYPE[0] = new GD_ADSRHEADER_UID1_TYPE_7();
				...
				if (HEADER.UID1 != null && HEADER.UID1 != "") {
					header.UID1 = new GD_ADSRHEADER_UID1_7[1];
					header.UID1[0] = new GD_ADSRHEADER_UID1_7();
				...
				if (HEADER.UID2_TYPE != null && HEADER.UID2_TYPE != "") {
					header.UID2_TYPE = new GD_ADSRHEADER_UID2_TYPE_7[1];
					header.UID2_TYPE[0] = new GD_ADSRHEADER_UID2_TYPE_7();
				...
				if (HEADER.UID2 != null && HEADER.UID2 != "") {
					header.UID2 = new GD_ADSRHEADER_UID2_7[1];
					header.UID2[0] = new GD_ADSRHEADER_UID2_7();
			...
			GD_ADSRCONTENT_7 content = new GD_ADSRCONTENT_7();
			if (this.CONTENT != null) {
				if (CONTENT.TRACK_AUTHORITY_NUMBER != "Null") {
					content.TRACK_AUTHORITY_NUMBER = new GD_ADSRCONTENT_TRACK_AUTHORITY_NUMBER_7[1];
					content.TRACK_AUTHORITY_NUMBER[0] = new GD_ADSRCONTENT_TRACK_AUTHORITY_NUMBER_7();
					content.TRACK_AUTHORITY_NUMBER[0].Value = CONTENT.TRACK_AUTHORITY_NUMBER;
				}

				if (CONTENT.ACTION != "Null") {
					content.ACTION = new GD_ADSRCONTENT_ACTION_7[1];
					content.ACTION[0] = new GD_ADSRCONTENT_ACTION_7();
					content.ACTION[0].Value = CONTENT.ACTION;
				}

				if (CONTENT.STATUS_CODE != "Null") {
					content.STATUS_CODE = new GD_ADSRCONTENT_STATUS_CODE_7[1];
					content.STATUS_CODE[0] = new GD_ADSRCONTENT_STATUS_CODE_7();
					content.STATUS_CODE[0].Value = CONTENT.STATUS_CODE;
				}

				if (CONTENT.ENGINE_INITIAL != "Null") {
					content.ENGINE_INITIAL = new GD_ADSRCONTENT_ENGINE_INITIAL_7[1];
					content.ENGINE_INITIAL[0] = new GD_ADSRCONTENT_ENGINE_INITIAL_7();
					content.ENGINE_INITIAL[0].Value = CONTENT.ENGINE_INITIAL;
				}

				if (CONTENT.ENGINE_NUMBER != "Null") {
					content.ENGINE_NUMBER = new GD_ADSRCONTENT_ENGINE_NUMBER_7[1];
					content.ENGINE_NUMBER[0] = new GD_ADSRCONTENT_ENGINE_NUMBER_7();
					content.ENGINE_NUMBER[0].Value = CONTENT.ENGINE_NUMBER;
				}

				if (CONTENT.CREW_ACK_REQUIRED != "Null") {
					content.CREW_ACK_REQUIRED = new GD_ADSRCONTENT_CREW_ACK_REQUIRED_7[1];
					content.CREW_ACK_REQUIRED[0] = new GD_ADSRCONTENT_CREW_ACK_REQUIRED_7();
					content.CREW_ACK_REQUIRED[0].Value = CONTENT.CREW_ACK_REQUIRED;
				}

				if (CONTENT.ELECTRONIC_ACK_REQUESTED != "Null") {
					content.ELECTRONIC_ACK_REQUESTED = new GD_ADSRCONTENT_ELECTRONIC_ACK_REQUESTED_7[1];
					content.ELECTRONIC_ACK_REQUESTED[0] = new GD_ADSRCONTENT_ELECTRONIC_ACK_REQUESTED_7();
					content.ELECTRONIC_ACK_REQUESTED[0].Value = CONTENT.ELECTRONIC_ACK_REQUESTED;
				}

			}

			gd_adsr_7.Items[0] = header;
			gd_adsr_7.Items[1] = content;
			return gd_adsr_7;
		}
		...
		public string toSteMessageHeader(string serializedXml, bool remote = false) {
			...
			string preScript = "";
			if (!remote) {
				preScript = "PASSTHRUOTC|GD-ADSR|";
			} else {
				preScript = "RanorexAgent:PASSTHRUOTC|GD-ADSR|";
			}
	...
	public partial class PTC_GD_ADSRHEADER_7 {
	...
	public partial class PTC_GD_ADSRCONTENT_7 {
	...
	public partial class GD_ADSR_7 {
		[System.Xml.Serialization.XmlElementAttribute("HEADER", typeof(GD_ADSRHEADER_7), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]

		[System.Xml.Serialization.XmlElementAttribute("CONTENT", typeof(GD_ADSRCONTENT_7), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_EVENT_DATE_7 {
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_EVENT_TIME_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_MESSAGE_ID_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_SEQUENCE_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_MESSAGE_VERSION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_MESSAGE_REVISION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_SOURCE_SYS_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_DESTINATION_SYS_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_DISTRICT_NAME_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_DISTRICT_SCAC_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_USER_ID_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_TRACK_FILE_VERSION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_HTRN_SCAC_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_HTRN_SYMBOL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_HTRN_SECTION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_HTRN_ORIGIN_DATE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_HENG_ENGINE_INITIAL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_HENG_ENGINE_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_UID1_TYPE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_UID1_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_UID2_TYPE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRHEADER_UID2_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRCONTENT_TRACK_AUTHORITY_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRCONTENT_ACTION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRCONTENT_STATUS_CODE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRCONTENT_ENGINE_INITIAL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRCONTENT_ENGINE_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRCONTENT_CREW_ACK_REQUIRED_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_ADSRCONTENT_ELECTRONIC_ACK_REQUESTED_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
