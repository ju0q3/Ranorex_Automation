...
{
    public partial class PTC_CD_BARS_2 {
        private PTC_CD_BARSHEADER_2 thisHEADER;
        private PTC_CD_BARSCONTENT_2 thisCONTENT;

        public PTC_CD_BARSHEADER_2 HEADER {
            get { return this.thisHEADER; }
            set { this.thisHEADER = value; }
        }

        public PTC_CD_BARSCONTENT_2 CONTENT {
            get { return this.thisCONTENT; }
            set { this.thisCONTENT = value; }
        }

        public static void createCD_BARS_2(
            ...
            PTC_CD_BARS_2 cD_BARS = new PTC_CD_BARS_2();
            ...
            PTC_CD_BARSCONTENT_2 content = new PTC_CD_BARSCONTENT_2();
            ...
            cD_BARS.HEADER = header;
            cD_BARS.CONTENT = content;

            CD_BARS_2 ptc_cd_bars = cD_BARS.toSerializableObject();
            fs = File.Create(temp+"/temp.request");
            serializer = new XmlSerializer(typeof(CD_BARS_2));
            var writer = new SteXmlTextWriter(fs);
            serializer.Serialize(writer, ptc_cd_bars);
            fs.Close();

            request = File.ReadAllText(temp+"/temp.request");
            request = cD_BARS.toSteMessageHeader(request);
            System.IO.File.WriteAllText(SteUtils.getOutboundDir()+SteUtils.getFileName(), request);
        }

        public static void createCD_BARS_2Msmq(
            //string header_event_date, 
            //string header_event_time, 
            //string header_message_id, 
            //string header_sequence_number, 
            ...
            CD_BARS_2 ptc_cd_bars = cD_BARS.toSerializableObject();
            serializer = new XmlSerializer(typeof(PTC_CD_BARS_2));
            StringWriter writer = new StringWriter();
            serializer.Serialize(writer, ptc_cd_bars);
            request = cD_BARS.toSteMessageHeader(writer.ToString());
            SteMessageQueue.Instance().Send(request, "PTC_CD-BARS");
        }

        public CD_BARS_2 toSerializableObject() {
            CD_BARS_2 cd_bars_2 = new CD_BARS_2();
            cd_bars_2.Items = new object[2];

            CD_BARSHEADER_2 header = new CD_BARSHEADER_2();
            if (this.HEADER != null) {
                if (this.HEADER.HEADER_EVENT_DATE != null) {
                    header.HEADER_EVENT_DATE = new CD_BARSHEADERHEADER_EVENT_DATE_2[1];
                    CD_BARSHEADERHEADER_EVENT_DATE_2 header_event_date = new CD_BARSHEADERHEADER_EVENT_DATE_2();
                ...
                if (this.HEADER.HEADER_EVENT_TIME != null) {
                    header.HEADER_EVENT_TIME = new CD_BARSHEADERHEADER_EVENT_TIME_2[1];
                    CD_BARSHEADERHEADER_EVENT_TIME_2 header_event_time = new CD_BARSHEADERHEADER_EVENT_TIME_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_ID != null) {
                    header.HEADER_MESSAGE_ID = new CD_BARSHEADERHEADER_MESSAGE_ID_2[1];
                    CD_BARSHEADERHEADER_MESSAGE_ID_2 header_message_id = new CD_BARSHEADERHEADER_MESSAGE_ID_2();
                ...
                if (this.HEADER.HEADER_SEQUENCE_NUMBER != null) {
                    header.HEADER_SEQUENCE_NUMBER = new CD_BARSHEADERHEADER_SEQUENCE_NUMBER_2[1];
                    CD_BARSHEADERHEADER_SEQUENCE_NUMBER_2 header_sequence_number = new CD_BARSHEADERHEADER_SEQUENCE_NUMBER_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_VERSION != null) {
                    header.HEADER_MESSAGE_VERSION = new CD_BARSHEADERHEADER_MESSAGE_VERSION_2[1];
                    CD_BARSHEADERHEADER_MESSAGE_VERSION_2 header_message_version = new CD_BARSHEADERHEADER_MESSAGE_VERSION_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_REVISION != null) {
                    header.HEADER_MESSAGE_REVISION = new CD_BARSHEADERHEADER_MESSAGE_REVISION_2[1];
                    CD_BARSHEADERHEADER_MESSAGE_REVISION_2 header_message_revision = new CD_BARSHEADERHEADER_MESSAGE_REVISION_2();
                ...
                if (this.HEADER.HEADER_SOURCE_SYS != null) {
                    header.HEADER_SOURCE_SYS = new CD_BARSHEADERHEADER_SOURCE_SYS_2[1];
                    CD_BARSHEADERHEADER_SOURCE_SYS_2 header_source_sys = new CD_BARSHEADERHEADER_SOURCE_SYS_2();
                ...
                if (this.HEADER.HEADER_DESTINATION_SYS != null) {
                    header.HEADER_DESTINATION_SYS = new CD_BARSHEADERHEADER_DESTINATION_SYS_2[1];
                    CD_BARSHEADERHEADER_DESTINATION_SYS_2 header_destination_sys = new CD_BARSHEADERHEADER_DESTINATION_SYS_2();
                ...
                if (this.HEADER.HEADER_DISTRICT_NAME != null) {
                    header.HEADER_DISTRICT_NAME = new CD_BARSHEADERHEADER_DISTRICT_NAME_2[1];
                    CD_BARSHEADERHEADER_DISTRICT_NAME_2 header_district_name = new CD_BARSHEADERHEADER_DISTRICT_NAME_2();
                ...
                if (this.HEADER.HEADER_DISTRICT_SCAC != null) {
                    header.HEADER_DISTRICT_SCAC = new CD_BARSHEADERHEADER_DISTRICT_SCAC_2[1];
                    CD_BARSHEADERHEADER_DISTRICT_SCAC_2 header_district_scac = new CD_BARSHEADERHEADER_DISTRICT_SCAC_2();
                ...
                if (this.HEADER.HEADER_USER_ID != null) {
                    header.HEADER_USER_ID = new CD_BARSHEADERHEADER_USER_ID_2[1];
                    CD_BARSHEADERHEADER_USER_ID_2 header_user_id = new CD_BARSHEADERHEADER_USER_ID_2();
            ...
            CD_BARSCONTENT_2 content = new CD_BARSCONTENT_2();
            if (this.CONTENT != null) {
                if (this.CONTENT.BULLETIN_ITEM_NUMBER != null) {
                    content.BULLETIN_ITEM_NUMBER = new CD_BARSCONTENTBULLETIN_ITEM_NUMBER_2[1];
                    CD_BARSCONTENTBULLETIN_ITEM_NUMBER_2 bulletin_item_number = new CD_BARSCONTENTBULLETIN_ITEM_NUMBER_2();
                ...
                if (this.CONTENT.SCAC != null) {
                    content.SCAC = new CD_BARSCONTENTSCAC_2[1];
                    CD_BARSCONTENTSCAC_2 scac = new CD_BARSCONTENTSCAC_2();
                    scac.Value = this.CONTENT.SCAC;
                    content.SCAC[0] = scac;
                }

                if (this.CONTENT.SYMBOL != null) {
                    content.SYMBOL = new CD_BARSCONTENTSYMBOL_2[1];
                    CD_BARSCONTENTSYMBOL_2 symbol = new CD_BARSCONTENTSYMBOL_2();
                    symbol.Value = this.CONTENT.SYMBOL;
                    content.SYMBOL[0] = symbol;
                }

                if (this.CONTENT.SECTION != null) {
                    content.SECTION = new CD_BARSCONTENTSECTION_2[1];
                    CD_BARSCONTENTSECTION_2 section = new CD_BARSCONTENTSECTION_2();
                    section.Value = this.CONTENT.SECTION;
                    content.SECTION[0] = section;
                }

                if (this.CONTENT.ORIGIN_DATE != null) {
                    content.ORIGIN_DATE = new CD_BARSCONTENTORIGIN_DATE_2[1];
                    CD_BARSCONTENTORIGIN_DATE_2 origin_date = new CD_BARSCONTENTORIGIN_DATE_2();
                    origin_date.Value = this.CONTENT.ORIGIN_DATE;
                    content.ORIGIN_DATE[0] = origin_date;
                }

                if (this.CONTENT.CREW_ACK_REQUIRED != null) {
                    content.CREW_ACK_REQUIRED = new CD_BARSCONTENTCREW_ACK_REQUIRED_2[1];
                    CD_BARSCONTENTCREW_ACK_REQUIRED_2 crew_ack_required = new CD_BARSCONTENTCREW_ACK_REQUIRED_2();
                ...
                if (this.CONTENT.ELECTRONIC_ACK_REQUESTED != null) {
                    content.ELECTRONIC_ACK_REQUESTED = new CD_BARSCONTENTELECTRONIC_ACK_REQUESTED_2[1];
                    CD_BARSCONTENTELECTRONIC_ACK_REQUESTED_2 electronic_ack_requested = new CD_BARSCONTENTELECTRONIC_ACK_REQUESTED_2();
                ...
                if (this.CONTENT.STATUS_CODE != null) {
                    content.STATUS_CODE = new CD_BARSCONTENTSTATUS_CODE_2[1];
                    CD_BARSCONTENTSTATUS_CODE_2 status_code = new CD_BARSCONTENTSTATUS_CODE_2();
                    status_code.Value = this.CONTENT.STATUS_CODE;
                    content.STATUS_CODE[0] = status_code;
                }

                if (this.CONTENT.ENGINE_INITIAL != null) {
                    content.ENGINE_INITIAL = new CD_BARSCONTENTENGINE_INITIAL_2[1];
                    CD_BARSCONTENTENGINE_INITIAL_2 engine_initial = new CD_BARSCONTENTENGINE_INITIAL_2();
                ...
                if (this.CONTENT.ENGINE_NUMBER != null) {
                    content.ENGINE_NUMBER = new CD_BARSCONTENTENGINE_NUMBER_2[1];
                    CD_BARSCONTENTENGINE_NUMBER_2 engine_number = new CD_BARSCONTENTENGINE_NUMBER_2();
            ...
            cd_bars_2.Items[0] = header;
            cd_bars_2.Items[1] = content;
            return cd_bars_2;
        }
        ...
        public string toSteMessageHeader(string serializedXml) {
            ...
            string header = "PASSTHRUOTC|CD-BARS|";
    ...
    public partial class PTC_CD_BARSHEADER_2 {
    ...
    public partial class PTC_CD_BARSCONTENT_2 {
    ...
    public partial class CD_BARS_2 {
        private object[] itemsField;

        [System.Xml.Serialization.XmlElementAttribute("HEADER", typeof(CD_BARSHEADER_2), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]

        [System.Xml.Serialization.XmlElementAttribute("CONTENT", typeof(CD_BARSCONTENT_2), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSHEADER_2 {
        private CD_BARSHEADERHEADER_EVENT_DATE_2[] HEADER_EVENT_DATEField;
        private CD_BARSHEADERHEADER_EVENT_TIME_2[] HEADER_EVENT_TIMEField;
        private CD_BARSHEADERHEADER_MESSAGE_ID_2[] HEADER_MESSAGE_IDField;
        private CD_BARSHEADERHEADER_SEQUENCE_NUMBER_2[] HEADER_SEQUENCE_NUMBERField;
        private CD_BARSHEADERHEADER_MESSAGE_VERSION_2[] HEADER_MESSAGE_VERSIONField;
        private CD_BARSHEADERHEADER_MESSAGE_REVISION_2[] HEADER_MESSAGE_REVISIONField;
        private CD_BARSHEADERHEADER_SOURCE_SYS_2[] HEADER_SOURCE_SYSField;
        private CD_BARSHEADERHEADER_DESTINATION_SYS_2[] HEADER_DESTINATION_SYSField;
        private CD_BARSHEADERHEADER_DISTRICT_NAME_2[] HEADER_DISTRICT_NAMEField;
        private CD_BARSHEADERHEADER_DISTRICT_SCAC_2[] HEADER_DISTRICT_SCACField;
        private CD_BARSHEADERHEADER_USER_ID_2[] HEADER_USER_IDField;

        [System.Xml.Serialization.XmlElementAttribute("HEADER_EVENT_DATE", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public CD_BARSHEADERHEADER_EVENT_DATE_2[] HEADER_EVENT_DATE {
        ...
        public CD_BARSHEADERHEADER_EVENT_TIME_2[] HEADER_EVENT_TIME {
        ...
        public CD_BARSHEADERHEADER_MESSAGE_ID_2[] HEADER_MESSAGE_ID {
        ...
        public CD_BARSHEADERHEADER_SEQUENCE_NUMBER_2[] HEADER_SEQUENCE_NUMBER {
        ...
        public CD_BARSHEADERHEADER_MESSAGE_VERSION_2[] HEADER_MESSAGE_VERSION {
        ...
        public CD_BARSHEADERHEADER_MESSAGE_REVISION_2[] HEADER_MESSAGE_REVISION {
        ...
        public CD_BARSHEADERHEADER_SOURCE_SYS_2[] HEADER_SOURCE_SYS {
        ...
        public CD_BARSHEADERHEADER_DESTINATION_SYS_2[] HEADER_DESTINATION_SYS {
        ...
        public CD_BARSHEADERHEADER_DISTRICT_NAME_2[] HEADER_DISTRICT_NAME {
        ...
        public CD_BARSHEADERHEADER_DISTRICT_SCAC_2[] HEADER_DISTRICT_SCAC {
        ...
        public CD_BARSHEADERHEADER_USER_ID_2[] HEADER_USER_ID {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSHEADERHEADER_EVENT_DATE_2 {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSHEADERHEADER_EVENT_TIME_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSHEADERHEADER_MESSAGE_ID_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSHEADERHEADER_SEQUENCE_NUMBER_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSHEADERHEADER_MESSAGE_VERSION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSHEADERHEADER_MESSAGE_REVISION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSHEADERHEADER_SOURCE_SYS_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSHEADERHEADER_DESTINATION_SYS_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSHEADERHEADER_DISTRICT_NAME_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSHEADERHEADER_DISTRICT_SCAC_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSHEADERHEADER_USER_ID_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSCONTENT_2 {
        private CD_BARSCONTENTBULLETIN_ITEM_NUMBER_2[] BULLETIN_ITEM_NUMBERField;
        private CD_BARSCONTENTSCAC_2[] SCACField;
        private CD_BARSCONTENTSYMBOL_2[] SYMBOLField;
        private CD_BARSCONTENTSECTION_2[] SECTIONField;
        private CD_BARSCONTENTORIGIN_DATE_2[] ORIGIN_DATEField;
        private CD_BARSCONTENTCREW_ACK_REQUIRED_2[] CREW_ACK_REQUIREDField;
        private CD_BARSCONTENTELECTRONIC_ACK_REQUESTED_2[] ELECTRONIC_ACK_REQUESTEDField;
        private CD_BARSCONTENTSTATUS_CODE_2[] STATUS_CODEField;
        private CD_BARSCONTENTENGINE_INITIAL_2[] ENGINE_INITIALField;
        private CD_BARSCONTENTENGINE_NUMBER_2[] ENGINE_NUMBERField;

        [System.Xml.Serialization.XmlElementAttribute("BULLETIN_ITEM_NUMBER", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public CD_BARSCONTENTBULLETIN_ITEM_NUMBER_2[] BULLETIN_ITEM_NUMBER {
        ...
        public CD_BARSCONTENTSCAC_2[] SCAC {
        ...
        public CD_BARSCONTENTSYMBOL_2[] SYMBOL {
        ...
        public CD_BARSCONTENTSECTION_2[] SECTION {
        ...
        public CD_BARSCONTENTORIGIN_DATE_2[] ORIGIN_DATE {
        ...
        public CD_BARSCONTENTCREW_ACK_REQUIRED_2[] CREW_ACK_REQUIRED {
        ...
        public CD_BARSCONTENTELECTRONIC_ACK_REQUESTED_2[] ELECTRONIC_ACK_REQUESTED {
        ...
        public CD_BARSCONTENTSTATUS_CODE_2[] STATUS_CODE {
        ...
        public CD_BARSCONTENTENGINE_INITIAL_2[] ENGINE_INITIAL {
        ...
        public CD_BARSCONTENTENGINE_NUMBER_2[] ENGINE_NUMBER {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSCONTENTBULLETIN_ITEM_NUMBER_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSCONTENTSCAC_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSCONTENTSYMBOL_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSCONTENTSECTION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSCONTENTORIGIN_DATE_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSCONTENTCREW_ACK_REQUIRED_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSCONTENTELECTRONIC_ACK_REQUESTED_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSCONTENTSTATUS_CODE_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSCONTENTENGINE_INITIAL_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_BARSCONTENTENGINE_NUMBER_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
