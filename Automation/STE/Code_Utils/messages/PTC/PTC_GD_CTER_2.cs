...
{
    public partial class PTC_GD_CTER_2 {
        private PTC_GD_CTERHEADER_2 thisHEADER;
        private PTC_GD_CTERCONTENT_2 thisCONTENT;

        public PTC_GD_CTERHEADER_2 HEADER {
            get { return this.thisHEADER; }
            set { this.thisHEADER = value; }
        }

        public PTC_GD_CTERCONTENT_2 CONTENT {
            get { return this.thisCONTENT; }
            set { this.thisCONTENT = value; }
        }

        public static void createGD_CTER_2(
            ...
            string req_time_extension
        ) {
            PTC_GD_CTER_2 gD_CTER = new PTC_GD_CTER_2();
            ...
            PTC_GD_CTERCONTENT_2 content = new PTC_GD_CTERCONTENT_2();
            ...
            content.REQ_TIME_EXTENSION = req_time_extension;

            gD_CTER.HEADER = header;
            gD_CTER.CONTENT = content;

            GD_CTER_2 ptc_gd_cter = gD_CTER.toSerializableObject();
            fs = File.Create(temp+"/temp.request");
            serializer = new XmlSerializer(typeof(GD_CTER_2));
            var writer = new SteXmlTextWriter(fs);
            serializer.Serialize(writer, ptc_gd_cter);
            fs.Close();

            request = File.ReadAllText(temp+"/temp.request");
            request = gD_CTER.toSteMessageHeader(request);
            System.IO.File.WriteAllText(SteUtils.getOutboundDir()+SteUtils.getFileName(), request);
        }

        public static void createGD_CTER_2Msmq(
            //string header_event_time, 
            //string header_event_time, 
            //string header_message_id, 
            //string header_sequence_number, 
            ...
            GD_CTER_2 ptc_gd_cter = gD_CTER.toSerializableObject();
            serializer = new XmlSerializer(typeof(PTC_GD_CTER_2));
            StringWriter writer = new StringWriter();
            serializer.Serialize(writer, ptc_gd_cter);
            request = gD_CTER.toSteMessageHeader(writer.ToString());
            SteMessageQueue.Instance().Send(request, "PTC_GD-CTER");
        }

        public GD_CTER_2 toSerializableObject() {
            GD_CTER_2 gd_cter_2 = new GD_CTER_2();
            gd_cter_2.Items = new object[2];

            GD_CTERHEADER_2 header = new GD_CTERHEADER_2();
            if (this.HEADER != null) {
                if (this.HEADER.HEADER_EVENT_DATE != null) {
                    header.HEADER_EVENT_DATE = new GD_CTERHEADERHEADER_EVENT_DATE_2[1];
                    GD_CTERHEADERHEADER_EVENT_DATE_2 header_event_date = new GD_CTERHEADERHEADER_EVENT_DATE_2();
                ...
                if (this.HEADER.HEADER_EVENT_TIME != null) {
                    header.HEADER_EVENT_TIME = new GD_CTERHEADERHEADER_EVENT_TIME_2[1];
                    GD_CTERHEADERHEADER_EVENT_TIME_2 header_event_time = new GD_CTERHEADERHEADER_EVENT_TIME_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_ID != null) {
                    header.HEADER_MESSAGE_ID = new GD_CTERHEADERHEADER_MESSAGE_ID_2[1];
                    GD_CTERHEADERHEADER_MESSAGE_ID_2 header_message_id = new GD_CTERHEADERHEADER_MESSAGE_ID_2();
                ...
                if (this.HEADER.HEADER_SEQUENCE_NUMBER != null) {
                    header.HEADER_SEQUENCE_NUMBER = new GD_CTERHEADERHEADER_SEQUENCE_NUMBER_2[1];
                    GD_CTERHEADERHEADER_SEQUENCE_NUMBER_2 header_sequence_number = new GD_CTERHEADERHEADER_SEQUENCE_NUMBER_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_VERSION != null) {
                    header.HEADER_MESSAGE_VERSION = new GD_CTERHEADERHEADER_MESSAGE_VERSION_2[1];
                    GD_CTERHEADERHEADER_MESSAGE_VERSION_2 header_message_version = new GD_CTERHEADERHEADER_MESSAGE_VERSION_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_REVISION != null) {
                    header.HEADER_MESSAGE_REVISION = new GD_CTERHEADERHEADER_MESSAGE_REVISION_2[1];
                    GD_CTERHEADERHEADER_MESSAGE_REVISION_2 header_message_revision = new GD_CTERHEADERHEADER_MESSAGE_REVISION_2();
                ...
                if (this.HEADER.HEADER_SOURCE_SYS != null) {
                    header.HEADER_SOURCE_SYS = new GD_CTERHEADERHEADER_SOURCE_SYS_2[1];
                    GD_CTERHEADERHEADER_SOURCE_SYS_2 header_source_sys = new GD_CTERHEADERHEADER_SOURCE_SYS_2();
                ...
                if (this.HEADER.HEADER_DESTINATION_SYS != null) {
                    header.HEADER_DESTINATION_SYS = new GD_CTERHEADERHEADER_DESTINATION_SYS_2[1];
                    GD_CTERHEADERHEADER_DESTINATION_SYS_2 header_destination_sys = new GD_CTERHEADERHEADER_DESTINATION_SYS_2();
                ...
                if (this.HEADER.HEADER_DISTRICT_NAME != null) {
                    header.HEADER_DISTRICT_NAME = new GD_CTERHEADERHEADER_DISTRICT_NAME_2[1];
                    GD_CTERHEADERHEADER_DISTRICT_NAME_2 header_district_name = new GD_CTERHEADERHEADER_DISTRICT_NAME_2();
                ...
                if (this.HEADER.HEADER_DISTRICT_SCAC != null) {
                    header.HEADER_DISTRICT_SCAC = new GD_CTERHEADERHEADER_DISTRICT_SCAC_2[1];
                    GD_CTERHEADERHEADER_DISTRICT_SCAC_2 header_district_scac = new GD_CTERHEADERHEADER_DISTRICT_SCAC_2();
                ...
                if (this.HEADER.HEADER_USER_ID != null) {
                    header.HEADER_USER_ID = new GD_CTERHEADERHEADER_USER_ID_2[1];
                    GD_CTERHEADERHEADER_USER_ID_2 header_user_id = new GD_CTERHEADERHEADER_USER_ID_2();
            ...
            GD_CTERCONTENT_2 content = new GD_CTERCONTENT_2();
            if (this.CONTENT != null) {
                if (this.CONTENT.TRACK_AUTHORITY_NUMBER != null) {
                    content.TRACK_AUTHORITY_NUMBER = new GD_CTERCONTENTTRACK_AUTHORITY_NUMBER_2[1];
                    GD_CTERCONTENTTRACK_AUTHORITY_NUMBER_2 track_authority_number = new GD_CTERCONTENTTRACK_AUTHORITY_NUMBER_2();
                ...
                if (this.CONTENT.EMPLOYEE_FIRST != null) {
                    content.EMPLOYEE_FIRST = new GD_CTERCONTENTEMPLOYEE_FIRST_2[1];
                    GD_CTERCONTENTEMPLOYEE_FIRST_2 employee_first = new GD_CTERCONTENTEMPLOYEE_FIRST_2();
                ...
                if (this.CONTENT.EMPLOYEE_MIDDLE != null) {
                    content.EMPLOYEE_MIDDLE = new GD_CTERCONTENTEMPLOYEE_MIDDLE_2[1];
                    GD_CTERCONTENTEMPLOYEE_MIDDLE_2 employee_middle = new GD_CTERCONTENTEMPLOYEE_MIDDLE_2();
                ...
                if (this.CONTENT.EMPLOYEE_LAST != null) {
                    content.EMPLOYEE_LAST = new GD_CTERCONTENTEMPLOYEE_LAST_2[1];
                    GD_CTERCONTENTEMPLOYEE_LAST_2 employee_last = new GD_CTERCONTENTEMPLOYEE_LAST_2();
                    employee_last.Value = this.CONTENT.EMPLOYEE_LAST;
                    content.EMPLOYEE_LAST[0] = employee_last;
                }

                if (this.CONTENT.REQ_TIME_EXTENSION != null) {
                    content.REQ_TIME_EXTENSION = new GD_CTERCONTENTREQ_TIME_EXTENSION_2[1];
                    GD_CTERCONTENTREQ_TIME_EXTENSION_2 req_time_extension = new GD_CTERCONTENTREQ_TIME_EXTENSION_2();
                    req_time_extension.Value = this.CONTENT.REQ_TIME_EXTENSION;
                    content.REQ_TIME_EXTENSION[0] = req_time_extension;
                }

            }

            gd_cter_2.Items[0] = header;
            gd_cter_2.Items[1] = content;
            return gd_cter_2;
        }
        ...
        public string toSteMessageHeader(string serializedXml) {
            ...
            string header = "PASSTHRUOTC|GD-CTER|";
    ...
    public partial class PTC_GD_CTERHEADER_2 {
    ...
    public partial class PTC_GD_CTERCONTENT_2 {
        ...
        private string thisREQ_TIME_EXTENSION = "";
        ...
        public string REQ_TIME_EXTENSION {
            get { return this.thisREQ_TIME_EXTENSION; }
            set { this.thisREQ_TIME_EXTENSION = value; }
        }
    ...
    public partial class GD_CTER_2 {
        private object[] itemsField;

        [System.Xml.Serialization.XmlElementAttribute("HEADER", typeof(GD_CTERHEADER_2), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]

        [System.Xml.Serialization.XmlElementAttribute("CONTENT", typeof(GD_CTERCONTENT_2), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERHEADER_2 {
        private GD_CTERHEADERHEADER_EVENT_DATE_2[] HEADER_EVENT_DATEField;
        private GD_CTERHEADERHEADER_EVENT_TIME_2[] HEADER_EVENT_TIMEField;
        private GD_CTERHEADERHEADER_MESSAGE_ID_2[] HEADER_MESSAGE_IDField;
        private GD_CTERHEADERHEADER_SEQUENCE_NUMBER_2[] HEADER_SEQUENCE_NUMBERField;
        private GD_CTERHEADERHEADER_MESSAGE_VERSION_2[] HEADER_MESSAGE_VERSIONField;
        private GD_CTERHEADERHEADER_MESSAGE_REVISION_2[] HEADER_MESSAGE_REVISIONField;
        private GD_CTERHEADERHEADER_SOURCE_SYS_2[] HEADER_SOURCE_SYSField;
        private GD_CTERHEADERHEADER_DESTINATION_SYS_2[] HEADER_DESTINATION_SYSField;
        private GD_CTERHEADERHEADER_DISTRICT_NAME_2[] HEADER_DISTRICT_NAMEField;
        private GD_CTERHEADERHEADER_DISTRICT_SCAC_2[] HEADER_DISTRICT_SCACField;
        private GD_CTERHEADERHEADER_USER_ID_2[] HEADER_USER_IDField;

        [System.Xml.Serialization.XmlElementAttribute("HEADER_EVENT_DATE", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public GD_CTERHEADERHEADER_EVENT_DATE_2[] HEADER_EVENT_DATE {
        ...
        public GD_CTERHEADERHEADER_EVENT_TIME_2[] HEADER_EVENT_TIME {
        ...
        public GD_CTERHEADERHEADER_MESSAGE_ID_2[] HEADER_MESSAGE_ID {
        ...
        public GD_CTERHEADERHEADER_SEQUENCE_NUMBER_2[] HEADER_SEQUENCE_NUMBER {
        ...
        public GD_CTERHEADERHEADER_MESSAGE_VERSION_2[] HEADER_MESSAGE_VERSION {
        ...
        public GD_CTERHEADERHEADER_MESSAGE_REVISION_2[] HEADER_MESSAGE_REVISION {
        ...
        public GD_CTERHEADERHEADER_SOURCE_SYS_2[] HEADER_SOURCE_SYS {
        ...
        public GD_CTERHEADERHEADER_DESTINATION_SYS_2[] HEADER_DESTINATION_SYS {
        ...
        public GD_CTERHEADERHEADER_DISTRICT_NAME_2[] HEADER_DISTRICT_NAME {
        ...
        public GD_CTERHEADERHEADER_DISTRICT_SCAC_2[] HEADER_DISTRICT_SCAC {
        ...
        public GD_CTERHEADERHEADER_USER_ID_2[] HEADER_USER_ID {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERHEADERHEADER_EVENT_DATE_2 {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERHEADERHEADER_EVENT_TIME_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERHEADERHEADER_MESSAGE_ID_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERHEADERHEADER_SEQUENCE_NUMBER_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERHEADERHEADER_MESSAGE_VERSION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERHEADERHEADER_MESSAGE_REVISION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERHEADERHEADER_SOURCE_SYS_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERHEADERHEADER_DESTINATION_SYS_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERHEADERHEADER_DISTRICT_NAME_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERHEADERHEADER_DISTRICT_SCAC_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERHEADERHEADER_USER_ID_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERCONTENT_2 {
        private GD_CTERCONTENTTRACK_AUTHORITY_NUMBER_2[] TRACK_AUTHORITY_NUMBERField;
        private GD_CTERCONTENTEMPLOYEE_FIRST_2[] EMPLOYEE_FIRSTField;
        private GD_CTERCONTENTEMPLOYEE_MIDDLE_2[] EMPLOYEE_MIDDLEField;
        private GD_CTERCONTENTEMPLOYEE_LAST_2[] EMPLOYEE_LASTField;
        private GD_CTERCONTENTREQ_TIME_EXTENSION_2[] REQ_TIME_EXTENSIONField;

        [System.Xml.Serialization.XmlElementAttribute("TRACK_AUTHORITY_NUMBER", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public GD_CTERCONTENTTRACK_AUTHORITY_NUMBER_2[] TRACK_AUTHORITY_NUMBER {
        ...
        public GD_CTERCONTENTEMPLOYEE_FIRST_2[] EMPLOYEE_FIRST {
        ...
        public GD_CTERCONTENTEMPLOYEE_MIDDLE_2[] EMPLOYEE_MIDDLE {
        ...
        public GD_CTERCONTENTEMPLOYEE_LAST_2[] EMPLOYEE_LAST {
        ...
        public GD_CTERCONTENTREQ_TIME_EXTENSION_2[] REQ_TIME_EXTENSION {
            get { return this.REQ_TIME_EXTENSIONField; }
            set { this.REQ_TIME_EXTENSIONField = value; }
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERCONTENTTRACK_AUTHORITY_NUMBER_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERCONTENTEMPLOYEE_FIRST_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERCONTENTEMPLOYEE_MIDDLE_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERCONTENTEMPLOYEE_LAST_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_CTERCONTENTREQ_TIME_EXTENSION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
