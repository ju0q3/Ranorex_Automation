...
{
	public partial class PTC_DC_DIBS_7 {
		public PTC_DC_DIBSHEADER_7 HEADER;
		public PTC_DC_DIBSCONTENT_7 CONTENT;

		public static PTC_DC_DIBS_7 fromSerializableObject(DC_DIBS_7 message) {
			PTC_DC_DIBS_7 dc_dibs_7 = new PTC_DC_DIBS_7();
			DC_DIBSHEADER_7 header = null;
			DC_DIBSCONTENT_7 content = null;
			header = (DC_DIBSHEADER_7) message.Items[0];
			content = (DC_DIBSCONTENT_7) message.Items[1];

			if (header != null) {
				PTC_DC_DIBSHEADER_7 messageheader = new PTC_DC_DIBSHEADER_7();
				...
				dc_dibs_7.HEADER = messageheader;
			...
			if (content != null) {
				PTC_DC_DIBSCONTENT_7 messagecontent = new PTC_DC_DIBSCONTENT_7();
				...
				if (content.DISTRICT_LIST != null) {
					for (int i = 0; i < content.DISTRICT_LIST.Length; i++) {
						PTC_DC_DIBSDISTRICT_LIST_7 district_list = new PTC_DC_DIBSDISTRICT_LIST_7();

						if (content.DISTRICT_LIST[i].DISTRICT_SEQUENCE != null) {
							district_list.DISTRICT_SEQUENCE = content.DISTRICT_LIST[i].DISTRICT_SEQUENCE[0].Value;
							if (district_list.DISTRICT_SEQUENCE != null) {
								if (district_list.DISTRICT_SEQUENCE.Length < 1 || district_list.DISTRICT_SEQUENCE.Length > 2) {
									Ranorex.Report.Failure("Field DISTRICT_SEQUENCE expected to be length between or equal to 1 and 2, has length of {" + district_list.DISTRICT_SEQUENCE.Length.ToString() + "}.");
								}
								if (!IsDigitsOnly(district_list.DISTRICT_SEQUENCE)) {
									Ranorex.Report.Failure("Field DISTRICT_SEQUENCE expected to be Numeric, has value of {" + district_list.DISTRICT_SEQUENCE + "}.");
								} else {
									int intConvertedValue = Convert.ToInt32(district_list.DISTRICT_SEQUENCE);
									if (intConvertedValue < 1 || intConvertedValue > 99) {
										Ranorex.Report.Failure("Field DISTRICT_SEQUENCE expected to have value between 1 and 99, but was found to have a value of " + district_list.DISTRICT_SEQUENCE + ".");
									}
								}
							}
						} else {
						...
						if (content.DISTRICT_LIST[i].DISTRICT != null) {
							district_list.DISTRICT = content.DISTRICT_LIST[i].DISTRICT[0].Value;
							if (district_list.DISTRICT != null) {
								if (district_list.DISTRICT.Length < 1 || district_list.DISTRICT.Length > 25) {
									Ranorex.Report.Failure("Field DISTRICT expected to be length between or equal to 1 and 25, has length of {" + district_list.DISTRICT.Length.ToString() + "}.");
								}
							}
						} else {
						...
						if (content.DISTRICT_LIST[i].BULLETIN_COUNT != null) {
							district_list.BULLETIN_COUNT = content.DISTRICT_LIST[i].BULLETIN_COUNT[0].Value;
							if (district_list.BULLETIN_COUNT != null) {
								if (district_list.BULLETIN_COUNT.Length < 1 || district_list.BULLETIN_COUNT.Length > 3) {
									Ranorex.Report.Failure("Field BULLETIN_COUNT expected to be length between or equal to 1 and 3, has length of {" + district_list.BULLETIN_COUNT.Length.ToString() + "}.");
								}
								if (!IsDigitsOnly(district_list.BULLETIN_COUNT)) {
									Ranorex.Report.Failure("Field BULLETIN_COUNT expected to be Numeric, has value of {" + district_list.BULLETIN_COUNT + "}.");
								}
							}
						} else {
							Ranorex.Report.Failure("Field BULLETIN_COUNT is a Mandatory field but was found to be missing from the message");
						}
						if (content.DISTRICT_LIST[i].BULLETIN_LIST != null) {
							for (int j = 0; j < content.DISTRICT_LIST[i].BULLETIN_LIST.Length; j++) {
								PTC_DC_DIBSBULLETIN_LIST_7 bulletin_list = new PTC_DC_DIBSBULLETIN_LIST_7();

								if (content.DISTRICT_LIST[i].BULLETIN_LIST[j].BULLETIN_ITEM_NUMBER != null) {
									bulletin_list.BULLETIN_ITEM_NUMBER = content.DISTRICT_LIST[i].BULLETIN_LIST[j].BULLETIN_ITEM_NUMBER[0].Value;
									if (bulletin_list.BULLETIN_ITEM_NUMBER != null) {
										if (bulletin_list.BULLETIN_ITEM_NUMBER.Length < 1 || bulletin_list.BULLETIN_ITEM_NUMBER.Length > 5) {
											Ranorex.Report.Failure("Field BULLETIN_ITEM_NUMBER expected to be length between or equal to 1 and 5, has length of {" + bulletin_list.BULLETIN_ITEM_NUMBER.Length.ToString() + "}.");
										}
										if (!IsDigitsOnly(bulletin_list.BULLETIN_ITEM_NUMBER)) {
											Ranorex.Report.Failure("Field BULLETIN_ITEM_NUMBER expected to be Numeric, has value of {" + bulletin_list.BULLETIN_ITEM_NUMBER + "}.");
										} else {
											int intConvertedValue = Convert.ToInt32(bulletin_list.BULLETIN_ITEM_NUMBER);
											if (intConvertedValue < 1 || intConvertedValue > 99999) {
												Ranorex.Report.Failure("Field BULLETIN_ITEM_NUMBER expected to have value between 1 and 99999, but was found to have a value of " + bulletin_list.BULLETIN_ITEM_NUMBER + ".");
											}
										}
									}
								} else {
								...
								if (content.DISTRICT_LIST[i].BULLETIN_LIST[j].BULLETIN_DISPLAY_SEQ != null) {
									bulletin_list.BULLETIN_DISPLAY_SEQ = content.DISTRICT_LIST[i].BULLETIN_LIST[j].BULLETIN_DISPLAY_SEQ[0].Value;
									if (bulletin_list.BULLETIN_DISPLAY_SEQ != null) {
										if (bulletin_list.BULLETIN_DISPLAY_SEQ.Length < 1 || bulletin_list.BULLETIN_DISPLAY_SEQ.Length > 3) {
											Ranorex.Report.Failure("Field BULLETIN_DISPLAY_SEQ expected to be length between or equal to 1 and 3, has length of {" + bulletin_list.BULLETIN_DISPLAY_SEQ.Length.ToString() + "}.");
										}
										if (!IsDigitsOnly(bulletin_list.BULLETIN_DISPLAY_SEQ)) {
											Ranorex.Report.Failure("Field BULLETIN_DISPLAY_SEQ expected to be Numeric, has value of {" + bulletin_list.BULLETIN_DISPLAY_SEQ + "}.");
										} else {
											int intConvertedValue = Convert.ToInt32(bulletin_list.BULLETIN_DISPLAY_SEQ);
											if (intConvertedValue < 1 || intConvertedValue > 999) {
												Ranorex.Report.Failure("Field BULLETIN_DISPLAY_SEQ expected to have value between 1 and 999, but was found to have a value of " + bulletin_list.BULLETIN_DISPLAY_SEQ + ".");
											}
										}
									}
								}
						...
						messagecontent.addDISTRICT_LIST(district_list);
					}
				}

				dc_dibs_7.CONTENT = messagecontent;
	...
	public partial class PTC_DC_DIBSHEADER_7 {
	...
	public partial class PTC_DC_DIBSCONTENT_7 {
		public string SCAC = "";
		public string SYMBOL = "";
		public string SECTION = "";
		public string ORIGIN_DATE = "";
		public string DISTRICT_COUNT = "";
		public ArrayList DISTRICT_LIST = new ArrayList();

		public void addDISTRICT_LIST(PTC_DC_DIBSDISTRICT_LIST_7 district_list) {
			this.DISTRICT_LIST.Add(district_list);
		}
	}

	public partial class PTC_DC_DIBSDISTRICT_LIST_7 {
		public string DISTRICT_SEQUENCE = "";
		public string DISTRICT = "";
		public string BULLETIN_COUNT = "";
		public ArrayList BULLETIN_LIST = new ArrayList();

		public void addBULLETIN_LIST(PTC_DC_DIBSBULLETIN_LIST_7 bulletin_list) {
			this.BULLETIN_LIST.Add(bulletin_list);
		}
	}

	public partial class PTC_DC_DIBSBULLETIN_LIST_7 {
	...
	public partial class DC_DIBS_7 {
		[System.Xml.Serialization.XmlElementAttribute("HEADER", typeof(DC_DIBSHEADER_7), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]

		[System.Xml.Serialization.XmlElementAttribute("CONTENT", typeof(DC_DIBSCONTENT_7), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_EVENT_DATE_7 {
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_EVENT_TIME_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_MESSAGE_ID_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_SEQUENCE_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_MESSAGE_VERSION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_MESSAGE_REVISION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_SOURCE_SYS_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_DESTINATION_SYS_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_DISTRICT_NAME_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_DISTRICT_SCAC_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_USER_ID_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_TRACK_FILE_VERSION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_HTRN_SCAC_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_HTRN_SYMBOL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_HTRN_SECTION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_HTRN_ORIGIN_DATE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_HENG_ENGINE_INITIAL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_HENG_ENGINE_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_UID1_TYPE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_UID1_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_UID2_TYPE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSHEADER_UID2_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSCONTENT_SCAC_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSCONTENT_SYMBOL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSCONTENT_SECTION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSCONTENT_ORIGIN_DATE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSCONTENT_DISTRICT_COUNT_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSDISTRICT_LIST_DISTRICT_SEQUENCE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSDISTRICT_LIST_DISTRICT_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSDISTRICT_LIST_BULLETIN_COUNT_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSBULLETIN_LIST_BULLETIN_ITEM_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class DC_DIBSBULLETIN_LIST_BULLETIN_DISPLAY_SEQ_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
