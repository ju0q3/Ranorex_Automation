...
{
	public partial class PTC_GD_CTVR_7 {
		public PTC_GD_CTVRHEADER_7 HEADER;
		public PTC_GD_CTVRCONTENT_7 CONTENT;
		public string JSONHeader;
		
		public static void createGD_CTVR_7(
...
//				}
		...
		public static PTC_GD_CTVR_7 buildPTC_GD_CTVR_7(
			string header_event_date,
			string header_event_time,
			string header_sequence_number,
			string header_message_version,
			...
			PTC_GD_CTVR_7 ptc_gd_ctvr = new PTC_GD_CTVR_7();

			PTC_GD_CTVRHEADER_7 header = new PTC_GD_CTVRHEADER_7();
			header.EVENT_DATE = header_event_date;
			header.EVENT_TIME = header_event_time;
			header.MESSAGE_ID = "GD-CTVR";
			...
			PTC_GD_CTVRCONTENT_7 content = new PTC_GD_CTVRCONTENT_7();
			...
			ptc_gd_ctvr.HEADER = header;
			ptc_gd_ctvr.CONTENT = content;
			return ptc_gd_ctvr;
		}

		public GD_CTVR_7 toSerializableObject() {
			GD_CTVR_7 gd_ctvr_7 = new GD_CTVR_7();
			gd_ctvr_7.Items = new object[2];

			GD_CTVRHEADER_7 header = new GD_CTVRHEADER_7();
			if (this.HEADER != null) {
				if (HEADER.EVENT_DATE != "Null") {
					header.EVENT_DATE = new GD_CTVRHEADER_EVENT_DATE_7[1];
					header.EVENT_DATE[0] = new GD_CTVRHEADER_EVENT_DATE_7();
					header.EVENT_DATE[0].Value = HEADER.EVENT_DATE;
				}

				if (HEADER.EVENT_TIME != "Null") {
					header.EVENT_TIME = new GD_CTVRHEADER_EVENT_TIME_7[1];
					header.EVENT_TIME[0] = new GD_CTVRHEADER_EVENT_TIME_7();
					header.EVENT_TIME[0].Value = HEADER.EVENT_TIME;
				}

				if (HEADER.MESSAGE_ID != "Null") {
					header.MESSAGE_ID = new GD_CTVRHEADER_MESSAGE_ID_7[1];
					header.MESSAGE_ID[0] = new GD_CTVRHEADER_MESSAGE_ID_7();
					header.MESSAGE_ID[0].Value = HEADER.MESSAGE_ID;
				}

				if (HEADER.SEQUENCE_NUMBER != "Null") {
					header.SEQUENCE_NUMBER = new GD_CTVRHEADER_SEQUENCE_NUMBER_7[1];
					header.SEQUENCE_NUMBER[0] = new GD_CTVRHEADER_SEQUENCE_NUMBER_7();
					header.SEQUENCE_NUMBER[0].Value = HEADER.SEQUENCE_NUMBER;
				}

				if (HEADER.MESSAGE_VERSION != "Null") {
					header.MESSAGE_VERSION = new GD_CTVRHEADER_MESSAGE_VERSION_7[1];
					header.MESSAGE_VERSION[0] = new GD_CTVRHEADER_MESSAGE_VERSION_7();
					header.MESSAGE_VERSION[0].Value = HEADER.MESSAGE_VERSION;
				}

				if (HEADER.MESSAGE_REVISION != "Null") {
					header.MESSAGE_REVISION = new GD_CTVRHEADER_MESSAGE_REVISION_7[1];
					header.MESSAGE_REVISION[0] = new GD_CTVRHEADER_MESSAGE_REVISION_7();
					header.MESSAGE_REVISION[0].Value = HEADER.MESSAGE_REVISION;
				}

				if (HEADER.SOURCE_SYS != "Null") {
					header.SOURCE_SYS = new GD_CTVRHEADER_SOURCE_SYS_7[1];
					header.SOURCE_SYS[0] = new GD_CTVRHEADER_SOURCE_SYS_7();
					header.SOURCE_SYS[0].Value = HEADER.SOURCE_SYS;
				}

				if (HEADER.DESTINATION_SYS != "Null") {
					header.DESTINATION_SYS = new GD_CTVRHEADER_DESTINATION_SYS_7[1];
					header.DESTINATION_SYS[0] = new GD_CTVRHEADER_DESTINATION_SYS_7();
					header.DESTINATION_SYS[0].Value = HEADER.DESTINATION_SYS;
				}

				if (HEADER.DISTRICT_NAME != null && HEADER.DISTRICT_NAME != "") {
					header.DISTRICT_NAME = new GD_CTVRHEADER_DISTRICT_NAME_7[1];
					header.DISTRICT_NAME[0] = new GD_CTVRHEADER_DISTRICT_NAME_7();
				...
				if (HEADER.DISTRICT_SCAC != null && HEADER.DISTRICT_SCAC != "") {
					header.DISTRICT_SCAC = new GD_CTVRHEADER_DISTRICT_SCAC_7[1];
					header.DISTRICT_SCAC[0] = new GD_CTVRHEADER_DISTRICT_SCAC_7();
				...
				if (HEADER.USER_ID != null && HEADER.USER_ID != "") {
					header.USER_ID = new GD_CTVRHEADER_USER_ID_7[1];
					header.USER_ID[0] = new GD_CTVRHEADER_USER_ID_7();
				...
				if (HEADER.TRACK_FILE_VERSION != null && HEADER.TRACK_FILE_VERSION != "") {
					header.TRACK_FILE_VERSION = new GD_CTVRHEADER_TRACK_FILE_VERSION_7[1];
					header.TRACK_FILE_VERSION[0] = new GD_CTVRHEADER_TRACK_FILE_VERSION_7();
				...
				if (HEADER.HTRN_SCAC != null && HEADER.HTRN_SCAC != "") {
					header.HTRN_SCAC = new GD_CTVRHEADER_HTRN_SCAC_7[1];
					header.HTRN_SCAC[0] = new GD_CTVRHEADER_HTRN_SCAC_7();
				...
				if (HEADER.HTRN_SYMBOL != null && HEADER.HTRN_SYMBOL != "") {
					header.HTRN_SYMBOL = new GD_CTVRHEADER_HTRN_SYMBOL_7[1];
					header.HTRN_SYMBOL[0] = new GD_CTVRHEADER_HTRN_SYMBOL_7();
				...
				if (HEADER.HTRN_SECTION != null && HEADER.HTRN_SECTION != "") {
					header.HTRN_SECTION = new GD_CTVRHEADER_HTRN_SECTION_7[1];
					header.HTRN_SECTION[0] = new GD_CTVRHEADER_HTRN_SECTION_7();
				...
				if (HEADER.HTRN_ORIGIN_DATE != null && HEADER.HTRN_ORIGIN_DATE != "") {
					header.HTRN_ORIGIN_DATE = new GD_CTVRHEADER_HTRN_ORIGIN_DATE_7[1];
					header.HTRN_ORIGIN_DATE[0] = new GD_CTVRHEADER_HTRN_ORIGIN_DATE_7();
				...
				if (HEADER.HENG_ENGINE_INITIAL != null && HEADER.HENG_ENGINE_INITIAL != "") {
					header.HENG_ENGINE_INITIAL = new GD_CTVRHEADER_HENG_ENGINE_INITIAL_7[1];
					header.HENG_ENGINE_INITIAL[0] = new GD_CTVRHEADER_HENG_ENGINE_INITIAL_7();
				...
				if (HEADER.HENG_ENGINE_NUMBER != null && HEADER.HENG_ENGINE_NUMBER != "") {
					header.HENG_ENGINE_NUMBER = new GD_CTVRHEADER_HENG_ENGINE_NUMBER_7[1];
					header.HENG_ENGINE_NUMBER[0] = new GD_CTVRHEADER_HENG_ENGINE_NUMBER_7();
				...
				if (HEADER.UID1_TYPE != null && HEADER.UID1_TYPE != "") {
					header.UID1_TYPE = new GD_CTVRHEADER_UID1_TYPE_7[1];
					header.UID1_TYPE[0] = new GD_CTVRHEADER_UID1_TYPE_7();
				...
				if (HEADER.UID1 != null && HEADER.UID1 != "") {
					header.UID1 = new GD_CTVRHEADER_UID1_7[1];
					header.UID1[0] = new GD_CTVRHEADER_UID1_7();
				...
				if (HEADER.UID2_TYPE != null && HEADER.UID2_TYPE != "") {
					header.UID2_TYPE = new GD_CTVRHEADER_UID2_TYPE_7[1];
					header.UID2_TYPE[0] = new GD_CTVRHEADER_UID2_TYPE_7();
				...
				if (HEADER.UID2 != null && HEADER.UID2 != "") {
					header.UID2 = new GD_CTVRHEADER_UID2_7[1];
					header.UID2[0] = new GD_CTVRHEADER_UID2_7();
			...
			GD_CTVRCONTENT_7 content = new GD_CTVRCONTENT_7();
			if (this.CONTENT != null) {
				if (CONTENT.TRACK_AUTHORITY_NUMBER != "Null") {
					content.TRACK_AUTHORITY_NUMBER = new GD_CTVRCONTENT_TRACK_AUTHORITY_NUMBER_7[1];
					content.TRACK_AUTHORITY_NUMBER[0] = new GD_CTVRCONTENT_TRACK_AUTHORITY_NUMBER_7();
					content.TRACK_AUTHORITY_NUMBER[0].Value = CONTENT.TRACK_AUTHORITY_NUMBER;
				}

				if (CONTENT.EMPLOYEE_FIRST != "Null") {
					content.EMPLOYEE_FIRST = new GD_CTVRCONTENT_EMPLOYEE_FIRST_7[1];
					content.EMPLOYEE_FIRST[0] = new GD_CTVRCONTENT_EMPLOYEE_FIRST_7();
					content.EMPLOYEE_FIRST[0].Value = CONTENT.EMPLOYEE_FIRST;
				}

				if (CONTENT.EMPLOYEE_MIDDLE != null && CONTENT.EMPLOYEE_MIDDLE != "") {
					content.EMPLOYEE_MIDDLE = new GD_CTVRCONTENT_EMPLOYEE_MIDDLE_7[1];
					content.EMPLOYEE_MIDDLE[0] = new GD_CTVRCONTENT_EMPLOYEE_MIDDLE_7();
				...
				if (CONTENT.EMPLOYEE_LAST != "Null") {
					content.EMPLOYEE_LAST = new GD_CTVRCONTENT_EMPLOYEE_LAST_7[1];
					content.EMPLOYEE_LAST[0] = new GD_CTVRCONTENT_EMPLOYEE_LAST_7();
					content.EMPLOYEE_LAST[0].Value = CONTENT.EMPLOYEE_LAST;
				}

				if (CONTENT.SPAF_ACK != null && CONTENT.SPAF_ACK != "") {
					content.SPAF_ACK = new GD_CTVRCONTENT_SPAF_ACK_7[1];
					content.SPAF_ACK[0] = new GD_CTVRCONTENT_SPAF_ACK_7();
			...
			gd_ctvr_7.Items[0] = header;
			gd_ctvr_7.Items[1] = content;
			return gd_ctvr_7;
		}
		...
		public string toSteMessageHeader(string serializedXml, bool remote = false) {
			...
			string preScript = "";
			if (!remote) {
				preScript = "PASSTHRUOTC|GD-CTVR|";
			} else {
				preScript = "RanorexAgent:PASSTHRUOTC|GD-CTVR|";
			}
	...
	public partial class PTC_GD_CTVRHEADER_7 {
	...
	public partial class PTC_GD_CTVRCONTENT_7 {
	...
	public partial class GD_CTVR_7 {
		[System.Xml.Serialization.XmlElementAttribute("HEADER", typeof(GD_CTVRHEADER_7), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]

		[System.Xml.Serialization.XmlElementAttribute("CONTENT", typeof(GD_CTVRCONTENT_7), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_EVENT_DATE_7 {
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_EVENT_TIME_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_MESSAGE_ID_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_SEQUENCE_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_MESSAGE_VERSION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_MESSAGE_REVISION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_SOURCE_SYS_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_DESTINATION_SYS_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_DISTRICT_NAME_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_DISTRICT_SCAC_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_USER_ID_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_TRACK_FILE_VERSION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_HTRN_SCAC_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_HTRN_SYMBOL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_HTRN_SECTION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_HTRN_ORIGIN_DATE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_HENG_ENGINE_INITIAL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_HENG_ENGINE_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_UID1_TYPE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_UID1_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_UID2_TYPE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRHEADER_UID2_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRCONTENT_TRACK_AUTHORITY_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRCONTENT_EMPLOYEE_FIRST_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRCONTENT_EMPLOYEE_MIDDLE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRCONTENT_EMPLOYEE_LAST_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_CTVRCONTENT_SPAF_ACK_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
