...
{
    public partial class PTC_CD_MEDS_2 {
        private PTC_CD_MEDSHEADER_2 thisHEADER;
        private PTC_CD_MEDSCONTENT_2 thisCONTENT;

        public PTC_CD_MEDSHEADER_2 HEADER {
            get { return this.thisHEADER; }
            set { this.thisHEADER = value; }
        }

        public PTC_CD_MEDSCONTENT_2 CONTENT {
            get { return this.thisCONTENT; }
            set { this.thisCONTENT = value; }
        }

        public static void createCD_MEDS_2(
            ...
            PTC_CD_MEDS_2 cD_MEDS = new PTC_CD_MEDS_2();
            ...
            PTC_CD_MEDSCONTENT_2 content = new PTC_CD_MEDSCONTENT_2();
            ...
            cD_MEDS.HEADER = header;
            cD_MEDS.CONTENT = content;

            CD_MEDS_2 ptc_cd_meds = cD_MEDS.toSerializableObject();
            fs = File.Create(temp+"/temp.request");
            serializer = new XmlSerializer(typeof(CD_MEDS_2));
            var writer = new SteXmlTextWriter(fs);
            serializer.Serialize(writer, ptc_cd_meds);
            fs.Close();

            request = File.ReadAllText(temp+"/temp.request");
            request = cD_MEDS.toSteMessageHeader(request);
            System.IO.File.WriteAllText(SteUtils.getOutboundDir()+SteUtils.getFileName(), request);
        }

        public static void createCD_MEDS_2Msmq(
            //string header_event_date, 
            //string header_event_time, 
            //string header_message_id, 
            //string header_sequence_number, 
            ...
            CD_MEDS_2 ptc_cd_meds = cD_MEDS.toSerializableObject();
            serializer = new XmlSerializer(typeof(PTC_CD_MEDS_2));
            StringWriter writer = new StringWriter();
            serializer.Serialize(writer, ptc_cd_meds);
            request = cD_MEDS.toSteMessageHeader(writer.ToString());
            SteMessageQueue.Instance().Send(request, "PTC_CD-MEDS");
        }

        public CD_MEDS_2 toSerializableObject() {
            CD_MEDS_2 cd_meds_2 = new CD_MEDS_2();
            cd_meds_2.Items = new object[2];

            CD_MEDSHEADER_2 header = new CD_MEDSHEADER_2();
            if (this.HEADER != null) {
                if (this.HEADER.HEADER_EVENT_DATE != null) {
                    header.HEADER_EVENT_DATE = new CD_MEDSHEADERHEADER_EVENT_DATE_2[1];
                    CD_MEDSHEADERHEADER_EVENT_DATE_2 header_event_date = new CD_MEDSHEADERHEADER_EVENT_DATE_2();
                ...
                if (this.HEADER.HEADER_EVENT_TIME != null) {
                    header.HEADER_EVENT_TIME = new CD_MEDSHEADERHEADER_EVENT_TIME_2[1];
                    CD_MEDSHEADERHEADER_EVENT_TIME_2 header_event_time = new CD_MEDSHEADERHEADER_EVENT_TIME_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_ID != null) {
                    header.HEADER_MESSAGE_ID = new CD_MEDSHEADERHEADER_MESSAGE_ID_2[1];
                    CD_MEDSHEADERHEADER_MESSAGE_ID_2 header_message_id = new CD_MEDSHEADERHEADER_MESSAGE_ID_2();
                ...
                if (this.HEADER.HEADER_SEQUENCE_NUMBER != null) {
                    header.HEADER_SEQUENCE_NUMBER = new CD_MEDSHEADERHEADER_SEQUENCE_NUMBER_2[1];
                    CD_MEDSHEADERHEADER_SEQUENCE_NUMBER_2 header_sequence_number = new CD_MEDSHEADERHEADER_SEQUENCE_NUMBER_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_VERSION != null) {
                    header.HEADER_MESSAGE_VERSION = new CD_MEDSHEADERHEADER_MESSAGE_VERSION_2[1];
                    CD_MEDSHEADERHEADER_MESSAGE_VERSION_2 header_message_version = new CD_MEDSHEADERHEADER_MESSAGE_VERSION_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_REVISION != null) {
                    header.HEADER_MESSAGE_REVISION = new CD_MEDSHEADERHEADER_MESSAGE_REVISION_2[1];
                    CD_MEDSHEADERHEADER_MESSAGE_REVISION_2 header_message_revision = new CD_MEDSHEADERHEADER_MESSAGE_REVISION_2();
                ...
                if (this.HEADER.HEADER_SOURCE_SYS != null) {
                    header.HEADER_SOURCE_SYS = new CD_MEDSHEADERHEADER_SOURCE_SYS_2[1];
                    CD_MEDSHEADERHEADER_SOURCE_SYS_2 header_source_sys = new CD_MEDSHEADERHEADER_SOURCE_SYS_2();
                ...
                if (this.HEADER.HEADER_DESTINATION_SYS != null) {
                    header.HEADER_DESTINATION_SYS = new CD_MEDSHEADERHEADER_DESTINATION_SYS_2[1];
                    CD_MEDSHEADERHEADER_DESTINATION_SYS_2 header_destination_sys = new CD_MEDSHEADERHEADER_DESTINATION_SYS_2();
                ...
                if (this.HEADER.HEADER_DISTRICT_NAME != null) {
                    header.HEADER_DISTRICT_NAME = new CD_MEDSHEADERHEADER_DISTRICT_NAME_2[1];
                    CD_MEDSHEADERHEADER_DISTRICT_NAME_2 header_district_name = new CD_MEDSHEADERHEADER_DISTRICT_NAME_2();
                ...
                if (this.HEADER.HEADER_DISTRICT_SCAC != null) {
                    header.HEADER_DISTRICT_SCAC = new CD_MEDSHEADERHEADER_DISTRICT_SCAC_2[1];
                    CD_MEDSHEADERHEADER_DISTRICT_SCAC_2 header_district_scac = new CD_MEDSHEADERHEADER_DISTRICT_SCAC_2();
                ...
                if (this.HEADER.HEADER_USER_ID != null) {
                    header.HEADER_USER_ID = new CD_MEDSHEADERHEADER_USER_ID_2[1];
                    CD_MEDSHEADERHEADER_USER_ID_2 header_user_id = new CD_MEDSHEADERHEADER_USER_ID_2();
            ...
            CD_MEDSCONTENT_2 content = new CD_MEDSCONTENT_2();
            if (this.CONTENT != null) {
                if (this.CONTENT.BULLETIN_ITEM_NUMBER != null) {
                    content.BULLETIN_ITEM_NUMBER = new CD_MEDSCONTENTBULLETIN_ITEM_NUMBER_2[1];
                    CD_MEDSCONTENTBULLETIN_ITEM_NUMBER_2 bulletin_item_number = new CD_MEDSCONTENTBULLETIN_ITEM_NUMBER_2();
                ...
                if (this.CONTENT.SCAC != null) {
                    content.SCAC = new CD_MEDSCONTENTSCAC_2[1];
                    CD_MEDSCONTENTSCAC_2 scac = new CD_MEDSCONTENTSCAC_2();
                    scac.Value = this.CONTENT.SCAC;
                    content.SCAC[0] = scac;
                }

                if (this.CONTENT.SYMBOL != null) {
                    content.SYMBOL = new CD_MEDSCONTENTSYMBOL_2[1];
                    CD_MEDSCONTENTSYMBOL_2 symbol = new CD_MEDSCONTENTSYMBOL_2();
                    symbol.Value = this.CONTENT.SYMBOL;
                    content.SYMBOL[0] = symbol;
                }

                if (this.CONTENT.SECTION != null) {
                    content.SECTION = new CD_MEDSCONTENTSECTION_2[1];
                    CD_MEDSCONTENTSECTION_2 section = new CD_MEDSCONTENTSECTION_2();
                    section.Value = this.CONTENT.SECTION;
                    content.SECTION[0] = section;
                }

                if (this.CONTENT.ORIGIN_DATE != null) {
                    content.ORIGIN_DATE = new CD_MEDSCONTENTORIGIN_DATE_2[1];
                    CD_MEDSCONTENTORIGIN_DATE_2 origin_date = new CD_MEDSCONTENTORIGIN_DATE_2();
                    origin_date.Value = this.CONTENT.ORIGIN_DATE;
                    content.ORIGIN_DATE[0] = origin_date;
                }

                if (this.CONTENT.STATUS_CODE != null) {
                    content.STATUS_CODE = new CD_MEDSCONTENTSTATUS_CODE_2[1];
                    CD_MEDSCONTENTSTATUS_CODE_2 status_code = new CD_MEDSCONTENTSTATUS_CODE_2();
                    status_code.Value = this.CONTENT.STATUS_CODE;
                    content.STATUS_CODE[0] = status_code;
                }

                if (this.CONTENT.ENGINE_INITIAL != null) {
                    content.ENGINE_INITIAL = new CD_MEDSCONTENTENGINE_INITIAL_2[1];
                    CD_MEDSCONTENTENGINE_INITIAL_2 engine_initial = new CD_MEDSCONTENTENGINE_INITIAL_2();
                ...
                if (this.CONTENT.ENGINE_NUMBER != null) {
                    content.ENGINE_NUMBER = new CD_MEDSCONTENTENGINE_NUMBER_2[1];
                    CD_MEDSCONTENTENGINE_NUMBER_2 engine_number = new CD_MEDSCONTENTENGINE_NUMBER_2();
            ...
            cd_meds_2.Items[0] = header;
            cd_meds_2.Items[1] = content;
            return cd_meds_2;
        }
        ...
        public string toSteMessageHeader(string serializedXml) {
            ...
            string header = "PASSTHRUOTC|CD-MEDS|";
    ...
    public partial class PTC_CD_MEDSHEADER_2 {
    ...
    public partial class PTC_CD_MEDSCONTENT_2 {
    ...
    public partial class CD_MEDS_2 {
        private object[] itemsField;

        [System.Xml.Serialization.XmlElementAttribute("HEADER", typeof(CD_MEDSHEADER_2), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]

        [System.Xml.Serialization.XmlElementAttribute("CONTENT", typeof(CD_MEDSCONTENT_2), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSHEADER_2 {
        private CD_MEDSHEADERHEADER_EVENT_DATE_2[] HEADER_EVENT_DATEField;
        private CD_MEDSHEADERHEADER_EVENT_TIME_2[] HEADER_EVENT_TIMEField;
        private CD_MEDSHEADERHEADER_MESSAGE_ID_2[] HEADER_MESSAGE_IDField;
        private CD_MEDSHEADERHEADER_SEQUENCE_NUMBER_2[] HEADER_SEQUENCE_NUMBERField;
        private CD_MEDSHEADERHEADER_MESSAGE_VERSION_2[] HEADER_MESSAGE_VERSIONField;
        private CD_MEDSHEADERHEADER_MESSAGE_REVISION_2[] HEADER_MESSAGE_REVISIONField;
        private CD_MEDSHEADERHEADER_SOURCE_SYS_2[] HEADER_SOURCE_SYSField;
        private CD_MEDSHEADERHEADER_DESTINATION_SYS_2[] HEADER_DESTINATION_SYSField;
        private CD_MEDSHEADERHEADER_DISTRICT_NAME_2[] HEADER_DISTRICT_NAMEField;
        private CD_MEDSHEADERHEADER_DISTRICT_SCAC_2[] HEADER_DISTRICT_SCACField;
        private CD_MEDSHEADERHEADER_USER_ID_2[] HEADER_USER_IDField;

        [System.Xml.Serialization.XmlElementAttribute("HEADER_EVENT_DATE", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public CD_MEDSHEADERHEADER_EVENT_DATE_2[] HEADER_EVENT_DATE {
        ...
        public CD_MEDSHEADERHEADER_EVENT_TIME_2[] HEADER_EVENT_TIME {
        ...
        public CD_MEDSHEADERHEADER_MESSAGE_ID_2[] HEADER_MESSAGE_ID {
        ...
        public CD_MEDSHEADERHEADER_SEQUENCE_NUMBER_2[] HEADER_SEQUENCE_NUMBER {
        ...
        public CD_MEDSHEADERHEADER_MESSAGE_VERSION_2[] HEADER_MESSAGE_VERSION {
        ...
        public CD_MEDSHEADERHEADER_MESSAGE_REVISION_2[] HEADER_MESSAGE_REVISION {
        ...
        public CD_MEDSHEADERHEADER_SOURCE_SYS_2[] HEADER_SOURCE_SYS {
        ...
        public CD_MEDSHEADERHEADER_DESTINATION_SYS_2[] HEADER_DESTINATION_SYS {
        ...
        public CD_MEDSHEADERHEADER_DISTRICT_NAME_2[] HEADER_DISTRICT_NAME {
        ...
        public CD_MEDSHEADERHEADER_DISTRICT_SCAC_2[] HEADER_DISTRICT_SCAC {
        ...
        public CD_MEDSHEADERHEADER_USER_ID_2[] HEADER_USER_ID {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSHEADERHEADER_EVENT_DATE_2 {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSHEADERHEADER_EVENT_TIME_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSHEADERHEADER_MESSAGE_ID_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSHEADERHEADER_SEQUENCE_NUMBER_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSHEADERHEADER_MESSAGE_VERSION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSHEADERHEADER_MESSAGE_REVISION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSHEADERHEADER_SOURCE_SYS_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSHEADERHEADER_DESTINATION_SYS_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSHEADERHEADER_DISTRICT_NAME_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSHEADERHEADER_DISTRICT_SCAC_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSHEADERHEADER_USER_ID_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSCONTENT_2 {
        private CD_MEDSCONTENTBULLETIN_ITEM_NUMBER_2[] BULLETIN_ITEM_NUMBERField;
        private CD_MEDSCONTENTSCAC_2[] SCACField;
        private CD_MEDSCONTENTSYMBOL_2[] SYMBOLField;
        private CD_MEDSCONTENTSECTION_2[] SECTIONField;
        private CD_MEDSCONTENTORIGIN_DATE_2[] ORIGIN_DATEField;
        private CD_MEDSCONTENTSTATUS_CODE_2[] STATUS_CODEField;
        private CD_MEDSCONTENTENGINE_INITIAL_2[] ENGINE_INITIALField;
        private CD_MEDSCONTENTENGINE_NUMBER_2[] ENGINE_NUMBERField;

        [System.Xml.Serialization.XmlElementAttribute("BULLETIN_ITEM_NUMBER", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public CD_MEDSCONTENTBULLETIN_ITEM_NUMBER_2[] BULLETIN_ITEM_NUMBER {
        ...
        public CD_MEDSCONTENTSCAC_2[] SCAC {
        ...
        public CD_MEDSCONTENTSYMBOL_2[] SYMBOL {
        ...
        public CD_MEDSCONTENTSECTION_2[] SECTION {
        ...
        public CD_MEDSCONTENTORIGIN_DATE_2[] ORIGIN_DATE {
        ...
        public CD_MEDSCONTENTSTATUS_CODE_2[] STATUS_CODE {
        ...
        public CD_MEDSCONTENTENGINE_INITIAL_2[] ENGINE_INITIAL {
        ...
        public CD_MEDSCONTENTENGINE_NUMBER_2[] ENGINE_NUMBER {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSCONTENTBULLETIN_ITEM_NUMBER_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSCONTENTSCAC_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSCONTENTSYMBOL_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSCONTENTSECTION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSCONTENTORIGIN_DATE_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSCONTENTSTATUS_CODE_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSCONTENTENGINE_INITIAL_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_MEDSCONTENTENGINE_NUMBER_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
