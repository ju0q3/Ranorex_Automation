...
{
	public partial class PTC_GD_EBAR_7 {
		public PTC_GD_EBARHEADER_7 HEADER;
		public PTC_GD_EBARCONTENT_7 CONTENT;

		public static void createGD_EBAR_7(
		...
		public static PTC_GD_EBAR_7 buildPTC_GD_EBAR_7(
			string header_event_date,
			string header_event_time,
			string header_sequence_number,
			string header_message_version,
			...
			PTC_GD_EBAR_7 ptc_gd_ebar = new PTC_GD_EBAR_7();

			PTC_GD_EBARHEADER_7 header = new PTC_GD_EBARHEADER_7();
			header.EVENT_DATE = header_event_date;
			header.EVENT_TIME = header_event_time;
			header.MESSAGE_ID = "GD-EBAR";
			...
			PTC_GD_EBARCONTENT_7 content = new PTC_GD_EBARCONTENT_7();
			...
			ptc_gd_ebar.HEADER = header;
			ptc_gd_ebar.CONTENT = content;
			return ptc_gd_ebar;
		}

		public GD_EBAR_7 toSerializableObject() {
			GD_EBAR_7 gd_ebar_7 = new GD_EBAR_7();
			gd_ebar_7.Items = new object[2];

			GD_EBARHEADER_7 header = new GD_EBARHEADER_7();
			if (this.HEADER != null) {
				if (HEADER.EVENT_DATE != "Null") {
					header.EVENT_DATE = new GD_EBARHEADER_EVENT_DATE_7[1];
					header.EVENT_DATE[0] = new GD_EBARHEADER_EVENT_DATE_7();
					header.EVENT_DATE[0].Value = HEADER.EVENT_DATE;
				}

				if (HEADER.EVENT_TIME != "Null") {
					header.EVENT_TIME = new GD_EBARHEADER_EVENT_TIME_7[1];
					header.EVENT_TIME[0] = new GD_EBARHEADER_EVENT_TIME_7();
					header.EVENT_TIME[0].Value = HEADER.EVENT_TIME;
				}

				if (HEADER.MESSAGE_ID != "Null") {
					header.MESSAGE_ID = new GD_EBARHEADER_MESSAGE_ID_7[1];
					header.MESSAGE_ID[0] = new GD_EBARHEADER_MESSAGE_ID_7();
					header.MESSAGE_ID[0].Value = HEADER.MESSAGE_ID;
				}

				if (HEADER.SEQUENCE_NUMBER != "Null") {
					header.SEQUENCE_NUMBER = new GD_EBARHEADER_SEQUENCE_NUMBER_7[1];
					header.SEQUENCE_NUMBER[0] = new GD_EBARHEADER_SEQUENCE_NUMBER_7();
					header.SEQUENCE_NUMBER[0].Value = HEADER.SEQUENCE_NUMBER;
				}

				if (HEADER.MESSAGE_VERSION != "Null") {
					header.MESSAGE_VERSION = new GD_EBARHEADER_MESSAGE_VERSION_7[1];
					header.MESSAGE_VERSION[0] = new GD_EBARHEADER_MESSAGE_VERSION_7();
					header.MESSAGE_VERSION[0].Value = HEADER.MESSAGE_VERSION;
				}

				if (HEADER.MESSAGE_REVISION != "Null") {
					header.MESSAGE_REVISION = new GD_EBARHEADER_MESSAGE_REVISION_7[1];
					header.MESSAGE_REVISION[0] = new GD_EBARHEADER_MESSAGE_REVISION_7();
					header.MESSAGE_REVISION[0].Value = HEADER.MESSAGE_REVISION;
				}

				if (HEADER.SOURCE_SYS != "Null") {
					header.SOURCE_SYS = new GD_EBARHEADER_SOURCE_SYS_7[1];
					header.SOURCE_SYS[0] = new GD_EBARHEADER_SOURCE_SYS_7();
					header.SOURCE_SYS[0].Value = HEADER.SOURCE_SYS;
				}

				if (HEADER.DESTINATION_SYS != "Null") {
					header.DESTINATION_SYS = new GD_EBARHEADER_DESTINATION_SYS_7[1];
					header.DESTINATION_SYS[0] = new GD_EBARHEADER_DESTINATION_SYS_7();
					header.DESTINATION_SYS[0].Value = HEADER.DESTINATION_SYS;
				}

				if (HEADER.DISTRICT_NAME != null && HEADER.DISTRICT_NAME != "") {
					header.DISTRICT_NAME = new GD_EBARHEADER_DISTRICT_NAME_7[1];
					header.DISTRICT_NAME[0] = new GD_EBARHEADER_DISTRICT_NAME_7();
				...
				if (HEADER.DISTRICT_SCAC != null && HEADER.DISTRICT_SCAC != "") {
					header.DISTRICT_SCAC = new GD_EBARHEADER_DISTRICT_SCAC_7[1];
					header.DISTRICT_SCAC[0] = new GD_EBARHEADER_DISTRICT_SCAC_7();
				...
				if (HEADER.USER_ID != null && HEADER.USER_ID != "") {
					header.USER_ID = new GD_EBARHEADER_USER_ID_7[1];
					header.USER_ID[0] = new GD_EBARHEADER_USER_ID_7();
				...
				if (HEADER.TRACK_FILE_VERSION != null && HEADER.TRACK_FILE_VERSION != "") {
					header.TRACK_FILE_VERSION = new GD_EBARHEADER_TRACK_FILE_VERSION_7[1];
					header.TRACK_FILE_VERSION[0] = new GD_EBARHEADER_TRACK_FILE_VERSION_7();
				...
				if (HEADER.HTRN_SCAC != null && HEADER.HTRN_SCAC != "") {
					header.HTRN_SCAC = new GD_EBARHEADER_HTRN_SCAC_7[1];
					header.HTRN_SCAC[0] = new GD_EBARHEADER_HTRN_SCAC_7();
				...
				if (HEADER.HTRN_SYMBOL != null && HEADER.HTRN_SYMBOL != "") {
					header.HTRN_SYMBOL = new GD_EBARHEADER_HTRN_SYMBOL_7[1];
					header.HTRN_SYMBOL[0] = new GD_EBARHEADER_HTRN_SYMBOL_7();
				...
				if (HEADER.HTRN_SECTION != null && HEADER.HTRN_SECTION != "") {
					header.HTRN_SECTION = new GD_EBARHEADER_HTRN_SECTION_7[1];
					header.HTRN_SECTION[0] = new GD_EBARHEADER_HTRN_SECTION_7();
				...
				if (HEADER.HTRN_ORIGIN_DATE != null && HEADER.HTRN_ORIGIN_DATE != "") {
					header.HTRN_ORIGIN_DATE = new GD_EBARHEADER_HTRN_ORIGIN_DATE_7[1];
					header.HTRN_ORIGIN_DATE[0] = new GD_EBARHEADER_HTRN_ORIGIN_DATE_7();
				...
				if (HEADER.HENG_ENGINE_INITIAL != null && HEADER.HENG_ENGINE_INITIAL != "") {
					header.HENG_ENGINE_INITIAL = new GD_EBARHEADER_HENG_ENGINE_INITIAL_7[1];
					header.HENG_ENGINE_INITIAL[0] = new GD_EBARHEADER_HENG_ENGINE_INITIAL_7();
				...
				if (HEADER.HENG_ENGINE_NUMBER != null && HEADER.HENG_ENGINE_NUMBER != "") {
					header.HENG_ENGINE_NUMBER = new GD_EBARHEADER_HENG_ENGINE_NUMBER_7[1];
					header.HENG_ENGINE_NUMBER[0] = new GD_EBARHEADER_HENG_ENGINE_NUMBER_7();
				...
				if (HEADER.UID1_TYPE != null && HEADER.UID1_TYPE != "") {
					header.UID1_TYPE = new GD_EBARHEADER_UID1_TYPE_7[1];
					header.UID1_TYPE[0] = new GD_EBARHEADER_UID1_TYPE_7();
				...
				if (HEADER.UID1 != null && HEADER.UID1 != "") {
					header.UID1 = new GD_EBARHEADER_UID1_7[1];
					header.UID1[0] = new GD_EBARHEADER_UID1_7();
				...
				if (HEADER.UID2_TYPE != null && HEADER.UID2_TYPE != "") {
					header.UID2_TYPE = new GD_EBARHEADER_UID2_TYPE_7[1];
					header.UID2_TYPE[0] = new GD_EBARHEADER_UID2_TYPE_7();
				...
				if (HEADER.UID2 != null && HEADER.UID2 != "") {
					header.UID2 = new GD_EBARHEADER_UID2_7[1];
					header.UID2[0] = new GD_EBARHEADER_UID2_7();
			...
			GD_EBARCONTENT_7 content = new GD_EBARCONTENT_7();
			if (this.CONTENT != null) {
				if (CONTENT.SCAC != "Null") {
					content.SCAC = new GD_EBARCONTENT_SCAC_7[1];
					content.SCAC[0] = new GD_EBARCONTENT_SCAC_7();
					content.SCAC[0].Value = CONTENT.SCAC;
				}

				if (CONTENT.SYMBOL != "Null") {
					content.SYMBOL = new GD_EBARCONTENT_SYMBOL_7[1];
					content.SYMBOL[0] = new GD_EBARCONTENT_SYMBOL_7();
					content.SYMBOL[0].Value = CONTENT.SYMBOL;
				}

				if (CONTENT.SECTION != null && CONTENT.SECTION != "") {
					content.SECTION = new GD_EBARCONTENT_SECTION_7[1];
					content.SECTION[0] = new GD_EBARCONTENT_SECTION_7();
				...
				if (CONTENT.ORIGIN_DATE != "Null") {
					content.ORIGIN_DATE = new GD_EBARCONTENT_ORIGIN_DATE_7[1];
					content.ORIGIN_DATE[0] = new GD_EBARCONTENT_ORIGIN_DATE_7();
					content.ORIGIN_DATE[0].Value = CONTENT.ORIGIN_DATE;
				}

				if (CONTENT.ENGINE_INITIAL != "Null") {
					content.ENGINE_INITIAL = new GD_EBARCONTENT_ENGINE_INITIAL_7[1];
					content.ENGINE_INITIAL[0] = new GD_EBARCONTENT_ENGINE_INITIAL_7();
					content.ENGINE_INITIAL[0].Value = CONTENT.ENGINE_INITIAL;
				}

				if (CONTENT.ENGINE_NUMBER != "Null") {
					content.ENGINE_NUMBER = new GD_EBARCONTENT_ENGINE_NUMBER_7[1];
					content.ENGINE_NUMBER[0] = new GD_EBARCONTENT_ENGINE_NUMBER_7();
					content.ENGINE_NUMBER[0].Value = CONTENT.ENGINE_NUMBER;
				}

				if (CONTENT.APPLICATION_DATE != "Null") {
					content.APPLICATION_DATE = new GD_EBARCONTENT_APPLICATION_DATE_7[1];
					content.APPLICATION_DATE[0] = new GD_EBARCONTENT_APPLICATION_DATE_7();
					content.APPLICATION_DATE[0].Value = CONTENT.APPLICATION_DATE;
				}

				if (CONTENT.APPLICATION_TIME != "Null") {
					content.APPLICATION_TIME = new GD_EBARCONTENT_APPLICATION_TIME_7[1];
					content.APPLICATION_TIME[0] = new GD_EBARCONTENT_APPLICATION_TIME_7();
					content.APPLICATION_TIME[0].Value = CONTENT.APPLICATION_TIME;
				}

				if (CONTENT.APPLICATION_TYPE != "Null") {
					content.APPLICATION_TYPE = new GD_EBARCONTENT_APPLICATION_TYPE_7[1];
					content.APPLICATION_TYPE[0] = new GD_EBARCONTENT_APPLICATION_TYPE_7();
					content.APPLICATION_TYPE[0].Value = CONTENT.APPLICATION_TYPE;
				}

				if (CONTENT.SPEED != "Null") {
					content.SPEED = new GD_EBARCONTENT_SPEED_7[1];
					content.SPEED[0] = new GD_EBARCONTENT_SPEED_7();
					content.SPEED[0].Value = CONTENT.SPEED;
				}

				if (CONTENT.DIRECTION != null && CONTENT.DIRECTION != "") {
					content.DIRECTION = new GD_EBARCONTENT_DIRECTION_7[1];
					content.DIRECTION[0] = new GD_EBARCONTENT_DIRECTION_7();
				...
				if (CONTENT.HE_DISTRICT != null && CONTENT.HE_DISTRICT != "") {
					content.HE_DISTRICT = new GD_EBARCONTENT_HE_DISTRICT_7[1];
					content.HE_DISTRICT[0] = new GD_EBARCONTENT_HE_DISTRICT_7();
				...
				if (CONTENT.HE_TRACK != null && CONTENT.HE_TRACK != "") {
					content.HE_TRACK = new GD_EBARCONTENT_HE_TRACK_7[1];
					content.HE_TRACK[0] = new GD_EBARCONTENT_HE_TRACK_7();
				...
				if (CONTENT.HE_MILEPOST != null && CONTENT.HE_MILEPOST != "") {
					content.HE_MILEPOST = new GD_EBARCONTENT_HE_MILEPOST_7[1];
					content.HE_MILEPOST[0] = new GD_EBARCONTENT_HE_MILEPOST_7();
				...
				if (CONTENT.RE_DISTRICT != null && CONTENT.RE_DISTRICT != "") {
					content.RE_DISTRICT = new GD_EBARCONTENT_RE_DISTRICT_7[1];
					content.RE_DISTRICT[0] = new GD_EBARCONTENT_RE_DISTRICT_7();
				...
				if (CONTENT.RE_TRACK != null && CONTENT.RE_TRACK != "") {
					content.RE_TRACK = new GD_EBARCONTENT_RE_TRACK_7[1];
					content.RE_TRACK[0] = new GD_EBARCONTENT_RE_TRACK_7();
				...
				if (CONTENT.RE_MILEPOST != null && CONTENT.RE_MILEPOST != "") {
					content.RE_MILEPOST = new GD_EBARCONTENT_RE_MILEPOST_7[1];
					content.RE_MILEPOST[0] = new GD_EBARCONTENT_RE_MILEPOST_7();
			...
			gd_ebar_7.Items[0] = header;
			gd_ebar_7.Items[1] = content;
			return gd_ebar_7;
		}
		...
		public string toSteMessageHeader(string serializedXml, bool remote = false) {
			...
			string preScript = "";
			if (!remote) {
				preScript = "PASSTHRUOTC|GD-EBAR|";
			} else {
				preScript = "RanorexAgent:PASSTHRUOTC|GD-EBAR|";
			}
	...
	public partial class PTC_GD_EBARHEADER_7 {
	...
	public partial class PTC_GD_EBARCONTENT_7 {
		public string SCAC = "";
	...
	public partial class GD_EBAR_7 {
		[System.Xml.Serialization.XmlElementAttribute("HEADER", typeof(GD_EBARHEADER_7), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]

		[System.Xml.Serialization.XmlElementAttribute("CONTENT", typeof(GD_EBARCONTENT_7), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_EVENT_DATE_7 {
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_EVENT_TIME_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_MESSAGE_ID_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_SEQUENCE_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_MESSAGE_VERSION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_MESSAGE_REVISION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_SOURCE_SYS_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_DESTINATION_SYS_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_DISTRICT_NAME_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_DISTRICT_SCAC_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_USER_ID_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_TRACK_FILE_VERSION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_HTRN_SCAC_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_HTRN_SYMBOL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_HTRN_SECTION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_HTRN_ORIGIN_DATE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_HENG_ENGINE_INITIAL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_HENG_ENGINE_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_UID1_TYPE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_UID1_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_UID2_TYPE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARHEADER_UID2_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_SCAC_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_SYMBOL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_SECTION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_ORIGIN_DATE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_ENGINE_INITIAL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_ENGINE_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_APPLICATION_DATE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_APPLICATION_TIME_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_APPLICATION_TYPE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_SPEED_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_DIRECTION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_HE_DISTRICT_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_HE_TRACK_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_HE_MILEPOST_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_RE_DISTRICT_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_RE_TRACK_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class GD_EBARCONTENT_RE_MILEPOST_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
