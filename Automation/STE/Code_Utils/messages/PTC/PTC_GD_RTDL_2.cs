...
{
    public partial class PTC_GD_RTDL_2 {
        private PTC_GD_RTDLHEADER_2 thisHEADER;
        private PTC_GD_RTDLCONTENT_2 thisCONTENT;

        public PTC_GD_RTDLHEADER_2 HEADER {
            get { return this.thisHEADER; }
            set { this.thisHEADER = value; }
        }

        public PTC_GD_RTDLCONTENT_2 CONTENT {
            get { return this.thisCONTENT; }
            set { this.thisCONTENT = value; }
        }

        public static void createGD_RTDL_2(
            ...
            PTC_GD_RTDL_2 gD_RTDL = new PTC_GD_RTDL_2();
            ...
            PTC_GD_RTDLCONTENT_2 content = new PTC_GD_RTDLCONTENT_2();
            content.SCAC = scac;
            ...
            gD_RTDL.HEADER = header;
            gD_RTDL.CONTENT = content;

            GD_RTDL_2 ptc_gd_rtdl = gD_RTDL.toSerializableObject();
            fs = File.Create(temp+"/temp.request");
            serializer = new XmlSerializer(typeof(GD_RTDL_2));
            var writer = new SteXmlTextWriter(fs);
            serializer.Serialize(writer, ptc_gd_rtdl);
            fs.Close();

            request = File.ReadAllText(temp+"/temp.request");
            request = gD_RTDL.toSteMessageHeader(request);
            System.IO.File.WriteAllText(SteUtils.getOutboundDir()+SteUtils.getFileName(), request);
        }

        public static void createGD_RTDL_2Msmq(
            //string header_event_time, 
            //string header_event_time, 
            //string header_message_id, 
            //string header_sequence_number, 
            ...
            GD_RTDL_2 ptc_gd_rtdl = gD_RTDL.toSerializableObject();
            serializer = new XmlSerializer(typeof(PTC_GD_RTDL_2));
            StringWriter writer = new StringWriter();
            serializer.Serialize(writer, ptc_gd_rtdl);
            request = gD_RTDL.toSteMessageHeader(writer.ToString());
            SteMessageQueue.Instance().Send(request, "PTC_GD-RTDL");
        }

        public GD_RTDL_2 toSerializableObject() {
            GD_RTDL_2 gd_rtdl_2 = new GD_RTDL_2();
            gd_rtdl_2.Items = new object[2];

            GD_RTDLHEADER_2 header = new GD_RTDLHEADER_2();
            if (this.HEADER != null) {
                if (this.HEADER.HEADER_EVENT_DATE != null) {
                    header.HEADER_EVENT_DATE = new GD_RTDLHEADERHEADER_EVENT_DATE_2[1];
                    GD_RTDLHEADERHEADER_EVENT_DATE_2 header_event_date = new GD_RTDLHEADERHEADER_EVENT_DATE_2();
                ...
                if (this.HEADER.HEADER_EVENT_TIME != null) {
                    header.HEADER_EVENT_TIME = new GD_RTDLHEADERHEADER_EVENT_TIME_2[1];
                    GD_RTDLHEADERHEADER_EVENT_TIME_2 header_event_time = new GD_RTDLHEADERHEADER_EVENT_TIME_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_ID != null) {
                    header.HEADER_MESSAGE_ID = new GD_RTDLHEADERHEADER_MESSAGE_ID_2[1];
                    GD_RTDLHEADERHEADER_MESSAGE_ID_2 header_message_id = new GD_RTDLHEADERHEADER_MESSAGE_ID_2();
                ...
                if (this.HEADER.HEADER_SEQUENCE_NUMBER != null) {
                    header.HEADER_SEQUENCE_NUMBER = new GD_RTDLHEADERHEADER_SEQUENCE_NUMBER_2[1];
                    GD_RTDLHEADERHEADER_SEQUENCE_NUMBER_2 header_sequence_number = new GD_RTDLHEADERHEADER_SEQUENCE_NUMBER_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_VERSION != null) {
                    header.HEADER_MESSAGE_VERSION = new GD_RTDLHEADERHEADER_MESSAGE_VERSION_2[1];
                    GD_RTDLHEADERHEADER_MESSAGE_VERSION_2 header_message_version = new GD_RTDLHEADERHEADER_MESSAGE_VERSION_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_REVISION != null) {
                    header.HEADER_MESSAGE_REVISION = new GD_RTDLHEADERHEADER_MESSAGE_REVISION_2[1];
                    GD_RTDLHEADERHEADER_MESSAGE_REVISION_2 header_message_revision = new GD_RTDLHEADERHEADER_MESSAGE_REVISION_2();
                ...
                if (this.HEADER.HEADER_SOURCE_SYS != null) {
                    header.HEADER_SOURCE_SYS = new GD_RTDLHEADERHEADER_SOURCE_SYS_2[1];
                    GD_RTDLHEADERHEADER_SOURCE_SYS_2 header_source_sys = new GD_RTDLHEADERHEADER_SOURCE_SYS_2();
                ...
                if (this.HEADER.HEADER_DESTINATION_SYS != null) {
                    header.HEADER_DESTINATION_SYS = new GD_RTDLHEADERHEADER_DESTINATION_SYS_2[1];
                    GD_RTDLHEADERHEADER_DESTINATION_SYS_2 header_destination_sys = new GD_RTDLHEADERHEADER_DESTINATION_SYS_2();
                ...
                if (this.HEADER.HEADER_DISTRICT_NAME != null) {
                    header.HEADER_DISTRICT_NAME = new GD_RTDLHEADERHEADER_DISTRICT_NAME_2[1];
                    GD_RTDLHEADERHEADER_DISTRICT_NAME_2 header_district_name = new GD_RTDLHEADERHEADER_DISTRICT_NAME_2();
                ...
                if (this.HEADER.HEADER_DISTRICT_SCAC != null) {
                    header.HEADER_DISTRICT_SCAC = new GD_RTDLHEADERHEADER_DISTRICT_SCAC_2[1];
                    GD_RTDLHEADERHEADER_DISTRICT_SCAC_2 header_district_scac = new GD_RTDLHEADERHEADER_DISTRICT_SCAC_2();
                ...
                if (this.HEADER.HEADER_USER_ID != null) {
                    header.HEADER_USER_ID = new GD_RTDLHEADERHEADER_USER_ID_2[1];
                    GD_RTDLHEADERHEADER_USER_ID_2 header_user_id = new GD_RTDLHEADERHEADER_USER_ID_2();
            ...
            GD_RTDLCONTENT_2 content = new GD_RTDLCONTENT_2();
            if (this.CONTENT != null) {
                if (this.CONTENT.SCAC != null) {
                    content.SCAC = new GD_RTDLCONTENTSCAC_2[1];
                    GD_RTDLCONTENTSCAC_2 scac = new GD_RTDLCONTENTSCAC_2();
                    scac.Value = this.CONTENT.SCAC;
                    content.SCAC[0] = scac;
                }

                if (this.CONTENT.SYMBOL != null) {
                    content.SYMBOL = new GD_RTDLCONTENTSYMBOL_2[1];
                    GD_RTDLCONTENTSYMBOL_2 symbol = new GD_RTDLCONTENTSYMBOL_2();
                    symbol.Value = this.CONTENT.SYMBOL;
                    content.SYMBOL[0] = symbol;
                }

                if (this.CONTENT.SECTION != null) {
                    content.SECTION = new GD_RTDLCONTENTSECTION_2[1];
                    GD_RTDLCONTENTSECTION_2 section = new GD_RTDLCONTENTSECTION_2();
                    section.Value = this.CONTENT.SECTION;
                    content.SECTION[0] = section;
                }

                if (this.CONTENT.ORIGIN_DATE != null) {
                    content.ORIGIN_DATE = new GD_RTDLCONTENTORIGIN_DATE_2[1];
                    GD_RTDLCONTENTORIGIN_DATE_2 origin_date = new GD_RTDLCONTENTORIGIN_DATE_2();
                    origin_date.Value = this.CONTENT.ORIGIN_DATE;
                    content.ORIGIN_DATE[0] = origin_date;
                }

                if (this.CONTENT.REQUEST_TYPE != null) {
                    content.REQUEST_TYPE = new GD_RTDLCONTENTREQUEST_TYPE_2[1];
                    GD_RTDLCONTENTREQUEST_TYPE_2 request_type = new GD_RTDLCONTENTREQUEST_TYPE_2();
                    request_type.Value = this.CONTENT.REQUEST_TYPE;
                    content.REQUEST_TYPE[0] = request_type;
                }

                if (this.CONTENT.TRIGGER_TYPE != null) {
                    content.TRIGGER_TYPE = new GD_RTDLCONTENTTRIGGER_TYPE_2[1];
                    GD_RTDLCONTENTTRIGGER_TYPE_2 trigger_type = new GD_RTDLCONTENTTRIGGER_TYPE_2();
            ...
            gd_rtdl_2.Items[0] = header;
            gd_rtdl_2.Items[1] = content;
            return gd_rtdl_2;
        }
        ...
        public string toSteMessageHeader(string serializedXml) {
            ...
            string header = "PASSTHRUOTC|GD-RTDL|";
    ...
    public partial class PTC_GD_RTDLHEADER_2 {
    ...
    public partial class PTC_GD_RTDLCONTENT_2 {
    ...
    public partial class GD_RTDL_2 {
        private object[] itemsField;

        [System.Xml.Serialization.XmlElementAttribute("HEADER", typeof(GD_RTDLHEADER_2), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]

        [System.Xml.Serialization.XmlElementAttribute("CONTENT", typeof(GD_RTDLCONTENT_2), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLHEADER_2 {
        private GD_RTDLHEADERHEADER_EVENT_DATE_2[] HEADER_EVENT_DATEField;
        private GD_RTDLHEADERHEADER_EVENT_TIME_2[] HEADER_EVENT_TIMEField;
        private GD_RTDLHEADERHEADER_MESSAGE_ID_2[] HEADER_MESSAGE_IDField;
        private GD_RTDLHEADERHEADER_SEQUENCE_NUMBER_2[] HEADER_SEQUENCE_NUMBERField;
        private GD_RTDLHEADERHEADER_MESSAGE_VERSION_2[] HEADER_MESSAGE_VERSIONField;
        private GD_RTDLHEADERHEADER_MESSAGE_REVISION_2[] HEADER_MESSAGE_REVISIONField;
        private GD_RTDLHEADERHEADER_SOURCE_SYS_2[] HEADER_SOURCE_SYSField;
        private GD_RTDLHEADERHEADER_DESTINATION_SYS_2[] HEADER_DESTINATION_SYSField;
        private GD_RTDLHEADERHEADER_DISTRICT_NAME_2[] HEADER_DISTRICT_NAMEField;
        private GD_RTDLHEADERHEADER_DISTRICT_SCAC_2[] HEADER_DISTRICT_SCACField;
        private GD_RTDLHEADERHEADER_USER_ID_2[] HEADER_USER_IDField;

        [System.Xml.Serialization.XmlElementAttribute("HEADER_EVENT_DATE", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public GD_RTDLHEADERHEADER_EVENT_DATE_2[] HEADER_EVENT_DATE {
        ...
        public GD_RTDLHEADERHEADER_EVENT_TIME_2[] HEADER_EVENT_TIME {
        ...
        public GD_RTDLHEADERHEADER_MESSAGE_ID_2[] HEADER_MESSAGE_ID {
        ...
        public GD_RTDLHEADERHEADER_SEQUENCE_NUMBER_2[] HEADER_SEQUENCE_NUMBER {
        ...
        public GD_RTDLHEADERHEADER_MESSAGE_VERSION_2[] HEADER_MESSAGE_VERSION {
        ...
        public GD_RTDLHEADERHEADER_MESSAGE_REVISION_2[] HEADER_MESSAGE_REVISION {
        ...
        public GD_RTDLHEADERHEADER_SOURCE_SYS_2[] HEADER_SOURCE_SYS {
        ...
        public GD_RTDLHEADERHEADER_DESTINATION_SYS_2[] HEADER_DESTINATION_SYS {
        ...
        public GD_RTDLHEADERHEADER_DISTRICT_NAME_2[] HEADER_DISTRICT_NAME {
        ...
        public GD_RTDLHEADERHEADER_DISTRICT_SCAC_2[] HEADER_DISTRICT_SCAC {
        ...
        public GD_RTDLHEADERHEADER_USER_ID_2[] HEADER_USER_ID {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLHEADERHEADER_EVENT_DATE_2 {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLHEADERHEADER_EVENT_TIME_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLHEADERHEADER_MESSAGE_ID_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLHEADERHEADER_SEQUENCE_NUMBER_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLHEADERHEADER_MESSAGE_VERSION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLHEADERHEADER_MESSAGE_REVISION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLHEADERHEADER_SOURCE_SYS_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLHEADERHEADER_DESTINATION_SYS_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLHEADERHEADER_DISTRICT_NAME_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLHEADERHEADER_DISTRICT_SCAC_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLHEADERHEADER_USER_ID_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLCONTENT_2 {
        private GD_RTDLCONTENTSCAC_2[] SCACField;
        private GD_RTDLCONTENTSYMBOL_2[] SYMBOLField;
        private GD_RTDLCONTENTSECTION_2[] SECTIONField;
        private GD_RTDLCONTENTORIGIN_DATE_2[] ORIGIN_DATEField;
        private GD_RTDLCONTENTREQUEST_TYPE_2[] REQUEST_TYPEField;
        private GD_RTDLCONTENTTRIGGER_TYPE_2[] TRIGGER_TYPEField;

        [System.Xml.Serialization.XmlElementAttribute("SCAC", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public GD_RTDLCONTENTSCAC_2[] SCAC {
        ...
        public GD_RTDLCONTENTSYMBOL_2[] SYMBOL {
        ...
        public GD_RTDLCONTENTSECTION_2[] SECTION {
        ...
        public GD_RTDLCONTENTORIGIN_DATE_2[] ORIGIN_DATE {
        ...
        public GD_RTDLCONTENTREQUEST_TYPE_2[] REQUEST_TYPE {
        ...
        public GD_RTDLCONTENTTRIGGER_TYPE_2[] TRIGGER_TYPE {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLCONTENTSCAC_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLCONTENTSYMBOL_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLCONTENTSECTION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLCONTENTORIGIN_DATE_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLCONTENTREQUEST_TYPE_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class GD_RTDLCONTENTTRIGGER_TYPE_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
