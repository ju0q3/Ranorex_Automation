...
{
	public partial class PTC_CD_BARS_7 {
		public PTC_CD_BARSHEADER_7 HEADER;
		public PTC_CD_BARSCONTENT_7 CONTENT;
		public string JSONHeader ;

		public static void createCD_BARS_7(
			...
			string content_crew_ack_required,
			string content_electronic_ack_requested,
			...
			PTC_CD_BARS_7 ptc_cd_bars = buildPTC_CD_BARS_7(header_event_date, header_event_time, header_sequence_number, header_message_version, header_message_revision, header_source_sys, header_destination_sys, header_district_name, header_district_scac, header_user_id, header_track_file_version, header_htrn_scac, header_htrn_symbol, header_htrn_section, header_htrn_origin_date, header_heng_engine_initial, header_heng_engine_number, header_uid1_type, header_uid1, header_uid2_type, header_uid2, content_bulletin_item_number, content_scac, content_symbol, content_section, content_origin_date, content_crew_ack_required, content_electronic_ack_requested, content_status_code, content_engine_initial, content_engine_number);
			ptc_cd_bars.JSONHeader="{  \"CMD\":\"SendTo\",  \"Destination\":\"MQServer\",  \"MSGID\"\":\"CD-BARS\",  \"Queue\"\":\"Auto\"}";

			CD_BARS_7 cd_bars = ptc_cd_bars.toSerializableObject();
			fs = File.Create(temp+"/temp.request");
			serializer = new XmlSerializer(typeof(CD_BARS_7));
			var writer = new SteXmlTextWriter(fs);
			serializer.Serialize(writer, cd_bars);
			fs.Close();

			string request = File.ReadAllText(temp+"/temp.request");
			request = ptc_cd_bars.toSteMessageHeader(request);
		...
		public static PTC_CD_BARS_7 buildPTC_CD_BARS_7(
			string header_event_date,
			string header_event_time,
			string header_sequence_number,
			string header_message_version,
			...
			PTC_CD_BARS_7 ptc_cd_bars = new PTC_CD_BARS_7();

			PTC_CD_BARSHEADER_7 header = new PTC_CD_BARSHEADER_7();
			header.EVENT_DATE = header_event_date;
			header.EVENT_TIME = header_event_time;
			header.MESSAGE_ID = "CD-BARS";
			...
			PTC_CD_BARSCONTENT_7 content = new PTC_CD_BARSCONTENT_7();
			...
			content.CREW_ACK_REQUIRED = content_crew_ack_required;
			content.ELECTRONIC_ACK_REQUESTED = content_electronic_ack_requested;
			...
			ptc_cd_bars.HEADER = header;
			ptc_cd_bars.CONTENT = content;
			return ptc_cd_bars;
		}

		public CD_BARS_7 toSerializableObject() {
			CD_BARS_7 cd_bars_7 = new CD_BARS_7();
			cd_bars_7.Items = new object[2];

			CD_BARSHEADER_7 header = new CD_BARSHEADER_7();
			if (this.HEADER != null) {
				if (HEADER.EVENT_DATE != "Null") {
					header.EVENT_DATE = new CD_BARSHEADER_EVENT_DATE_7[1];
					header.EVENT_DATE[0] = new CD_BARSHEADER_EVENT_DATE_7();
					header.EVENT_DATE[0].Value = HEADER.EVENT_DATE;
				}

				if (HEADER.EVENT_TIME != "Null") {
					header.EVENT_TIME = new CD_BARSHEADER_EVENT_TIME_7[1];
					header.EVENT_TIME[0] = new CD_BARSHEADER_EVENT_TIME_7();
					header.EVENT_TIME[0].Value = HEADER.EVENT_TIME;
				}

				if (HEADER.MESSAGE_ID != "Null") {
					header.MESSAGE_ID = new CD_BARSHEADER_MESSAGE_ID_7[1];
					header.MESSAGE_ID[0] = new CD_BARSHEADER_MESSAGE_ID_7();
					header.MESSAGE_ID[0].Value = HEADER.MESSAGE_ID;
				}

				if (HEADER.SEQUENCE_NUMBER != "Null") {
					header.SEQUENCE_NUMBER = new CD_BARSHEADER_SEQUENCE_NUMBER_7[1];
					header.SEQUENCE_NUMBER[0] = new CD_BARSHEADER_SEQUENCE_NUMBER_7();
					header.SEQUENCE_NUMBER[0].Value = HEADER.SEQUENCE_NUMBER;
				}

				if (HEADER.MESSAGE_VERSION != "Null") {
					header.MESSAGE_VERSION = new CD_BARSHEADER_MESSAGE_VERSION_7[1];
					header.MESSAGE_VERSION[0] = new CD_BARSHEADER_MESSAGE_VERSION_7();
					header.MESSAGE_VERSION[0].Value = HEADER.MESSAGE_VERSION;
				}

				if (HEADER.MESSAGE_REVISION != "Null") {
					header.MESSAGE_REVISION = new CD_BARSHEADER_MESSAGE_REVISION_7[1];
					header.MESSAGE_REVISION[0] = new CD_BARSHEADER_MESSAGE_REVISION_7();
					header.MESSAGE_REVISION[0].Value = HEADER.MESSAGE_REVISION;
				}

				if (HEADER.SOURCE_SYS != "Null") {
					header.SOURCE_SYS = new CD_BARSHEADER_SOURCE_SYS_7[1];
					header.SOURCE_SYS[0] = new CD_BARSHEADER_SOURCE_SYS_7();
					header.SOURCE_SYS[0].Value = HEADER.SOURCE_SYS;
				}

				if (HEADER.DESTINATION_SYS != "Null") {
					header.DESTINATION_SYS = new CD_BARSHEADER_DESTINATION_SYS_7[1];
					header.DESTINATION_SYS[0] = new CD_BARSHEADER_DESTINATION_SYS_7();
					header.DESTINATION_SYS[0].Value = HEADER.DESTINATION_SYS;
				}

				if (HEADER.DISTRICT_NAME != null && HEADER.DISTRICT_NAME != "") {
					header.DISTRICT_NAME = new CD_BARSHEADER_DISTRICT_NAME_7[1];
					header.DISTRICT_NAME[0] = new CD_BARSHEADER_DISTRICT_NAME_7();
				...
				if (HEADER.DISTRICT_SCAC != null && HEADER.DISTRICT_SCAC != "") {
					header.DISTRICT_SCAC = new CD_BARSHEADER_DISTRICT_SCAC_7[1];
					header.DISTRICT_SCAC[0] = new CD_BARSHEADER_DISTRICT_SCAC_7();
				...
				if (HEADER.USER_ID != null && HEADER.USER_ID != "") {
					header.USER_ID = new CD_BARSHEADER_USER_ID_7[1];
					header.USER_ID[0] = new CD_BARSHEADER_USER_ID_7();
				...
				if (HEADER.TRACK_FILE_VERSION != null && HEADER.TRACK_FILE_VERSION != "") {
					header.TRACK_FILE_VERSION = new CD_BARSHEADER_TRACK_FILE_VERSION_7[1];
					header.TRACK_FILE_VERSION[0] = new CD_BARSHEADER_TRACK_FILE_VERSION_7();
				...
				if (HEADER.HTRN_SCAC != null && HEADER.HTRN_SCAC != "") {
					header.HTRN_SCAC = new CD_BARSHEADER_HTRN_SCAC_7[1];
					header.HTRN_SCAC[0] = new CD_BARSHEADER_HTRN_SCAC_7();
				...
				if (HEADER.HTRN_SYMBOL != null && HEADER.HTRN_SYMBOL != "") {
					header.HTRN_SYMBOL = new CD_BARSHEADER_HTRN_SYMBOL_7[1];
					header.HTRN_SYMBOL[0] = new CD_BARSHEADER_HTRN_SYMBOL_7();
				...
				if (HEADER.HTRN_SECTION != null && HEADER.HTRN_SECTION != "") {
					header.HTRN_SECTION = new CD_BARSHEADER_HTRN_SECTION_7[1];
					header.HTRN_SECTION[0] = new CD_BARSHEADER_HTRN_SECTION_7();
				...
				if (HEADER.HTRN_ORIGIN_DATE != null && HEADER.HTRN_ORIGIN_DATE != "") {
					header.HTRN_ORIGIN_DATE = new CD_BARSHEADER_HTRN_ORIGIN_DATE_7[1];
					header.HTRN_ORIGIN_DATE[0] = new CD_BARSHEADER_HTRN_ORIGIN_DATE_7();
				...
				if (HEADER.HENG_ENGINE_INITIAL != null && HEADER.HENG_ENGINE_INITIAL != "") {
					header.HENG_ENGINE_INITIAL = new CD_BARSHEADER_HENG_ENGINE_INITIAL_7[1];
					header.HENG_ENGINE_INITIAL[0] = new CD_BARSHEADER_HENG_ENGINE_INITIAL_7();
				...
				if (HEADER.HENG_ENGINE_NUMBER != null && HEADER.HENG_ENGINE_NUMBER != "") {
					header.HENG_ENGINE_NUMBER = new CD_BARSHEADER_HENG_ENGINE_NUMBER_7[1];
					header.HENG_ENGINE_NUMBER[0] = new CD_BARSHEADER_HENG_ENGINE_NUMBER_7();
				...
				if (HEADER.UID1_TYPE != null && HEADER.UID1_TYPE != "") {
					header.UID1_TYPE = new CD_BARSHEADER_UID1_TYPE_7[1];
					header.UID1_TYPE[0] = new CD_BARSHEADER_UID1_TYPE_7();
				...
				if (HEADER.UID1 != null && HEADER.UID1 != "") {
					header.UID1 = new CD_BARSHEADER_UID1_7[1];
					header.UID1[0] = new CD_BARSHEADER_UID1_7();
				...
				if (HEADER.UID2_TYPE != null && HEADER.UID2_TYPE != "") {
					header.UID2_TYPE = new CD_BARSHEADER_UID2_TYPE_7[1];
					header.UID2_TYPE[0] = new CD_BARSHEADER_UID2_TYPE_7();
				...
				if (HEADER.UID2 != null && HEADER.UID2 != "") {
					header.UID2 = new CD_BARSHEADER_UID2_7[1];
					header.UID2[0] = new CD_BARSHEADER_UID2_7();
			...
			CD_BARSCONTENT_7 content = new CD_BARSCONTENT_7();
			if (this.CONTENT != null) {
				if (CONTENT.BULLETIN_ITEM_NUMBER != "Null") {
					content.BULLETIN_ITEM_NUMBER = new CD_BARSCONTENT_BULLETIN_ITEM_NUMBER_7[1];
					content.BULLETIN_ITEM_NUMBER[0] = new CD_BARSCONTENT_BULLETIN_ITEM_NUMBER_7();
					content.BULLETIN_ITEM_NUMBER[0].Value = CONTENT.BULLETIN_ITEM_NUMBER;
				}

				if (CONTENT.SCAC != "Null") {
					content.SCAC = new CD_BARSCONTENT_SCAC_7[1];
					content.SCAC[0] = new CD_BARSCONTENT_SCAC_7();
					content.SCAC[0].Value = CONTENT.SCAC;
				}

				if (CONTENT.SYMBOL != "Null") {
					content.SYMBOL = new CD_BARSCONTENT_SYMBOL_7[1];
					content.SYMBOL[0] = new CD_BARSCONTENT_SYMBOL_7();
					content.SYMBOL[0].Value = CONTENT.SYMBOL;
				}

				if (CONTENT.SECTION != null && CONTENT.SECTION != "") {
					content.SECTION = new CD_BARSCONTENT_SECTION_7[1];
					content.SECTION[0] = new CD_BARSCONTENT_SECTION_7();
				...
				if (CONTENT.ORIGIN_DATE != "Null") {
					content.ORIGIN_DATE = new CD_BARSCONTENT_ORIGIN_DATE_7[1];
					content.ORIGIN_DATE[0] = new CD_BARSCONTENT_ORIGIN_DATE_7();
					content.ORIGIN_DATE[0].Value = CONTENT.ORIGIN_DATE;
				}

				if (CONTENT.CREW_ACK_REQUIRED != "Null") {
					content.CREW_ACK_REQUIRED = new CD_BARSCONTENT_CREW_ACK_REQUIRED_7[1];
					content.CREW_ACK_REQUIRED[0] = new CD_BARSCONTENT_CREW_ACK_REQUIRED_7();
					content.CREW_ACK_REQUIRED[0].Value = CONTENT.CREW_ACK_REQUIRED;
				}

				if (CONTENT.ELECTRONIC_ACK_REQUESTED != "Null") {
					content.ELECTRONIC_ACK_REQUESTED = new CD_BARSCONTENT_ELECTRONIC_ACK_REQUESTED_7[1];
					content.ELECTRONIC_ACK_REQUESTED[0] = new CD_BARSCONTENT_ELECTRONIC_ACK_REQUESTED_7();
					content.ELECTRONIC_ACK_REQUESTED[0].Value = CONTENT.ELECTRONIC_ACK_REQUESTED;
				}

				if (CONTENT.STATUS_CODE != "Null") {
					content.STATUS_CODE = new CD_BARSCONTENT_STATUS_CODE_7[1];
					content.STATUS_CODE[0] = new CD_BARSCONTENT_STATUS_CODE_7();
					content.STATUS_CODE[0].Value = CONTENT.STATUS_CODE;
				}

				if (CONTENT.ENGINE_INITIAL != "Null") {
					content.ENGINE_INITIAL = new CD_BARSCONTENT_ENGINE_INITIAL_7[1];
					content.ENGINE_INITIAL[0] = new CD_BARSCONTENT_ENGINE_INITIAL_7();
					content.ENGINE_INITIAL[0].Value = CONTENT.ENGINE_INITIAL;
				}

				if (CONTENT.ENGINE_NUMBER != "Null") {
					content.ENGINE_NUMBER = new CD_BARSCONTENT_ENGINE_NUMBER_7[1];
					content.ENGINE_NUMBER[0] = new CD_BARSCONTENT_ENGINE_NUMBER_7();
					content.ENGINE_NUMBER[0].Value = CONTENT.ENGINE_NUMBER;
				}

			}

			cd_bars_7.Items[0] = header;
			cd_bars_7.Items[1] = content;
			return cd_bars_7;
		}
		...
		public string toSteMessageHeader(string serializedXml, bool remote = false) {
			...
			string preScript = "";
			if (!remote) {
				preScript = "PASSTHRUOTC|CD-BARS|";
			} else {
				preScript = "RanorexAgent:PASSTHRUOTC|CD-BARS|";
			}
	...
	public partial class PTC_CD_BARSHEADER_7 {
	...
	public partial class PTC_CD_BARSCONTENT_7 {
	...
	public partial class CD_BARS_7 {
		[System.Xml.Serialization.XmlElementAttribute("HEADER", typeof(CD_BARSHEADER_7), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]

		[System.Xml.Serialization.XmlElementAttribute("CONTENT", typeof(CD_BARSCONTENT_7), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_EVENT_DATE_7 {
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_EVENT_TIME_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_MESSAGE_ID_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_SEQUENCE_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_MESSAGE_VERSION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_MESSAGE_REVISION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_SOURCE_SYS_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_DESTINATION_SYS_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_DISTRICT_NAME_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_DISTRICT_SCAC_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_USER_ID_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_TRACK_FILE_VERSION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_HTRN_SCAC_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_HTRN_SYMBOL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_HTRN_SECTION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_HTRN_ORIGIN_DATE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_HENG_ENGINE_INITIAL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_HENG_ENGINE_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_UID1_TYPE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_UID1_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_UID2_TYPE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSHEADER_UID2_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSCONTENT_BULLETIN_ITEM_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSCONTENT_SCAC_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSCONTENT_SYMBOL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSCONTENT_SECTION_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSCONTENT_ORIGIN_DATE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSCONTENT_CREW_ACK_REQUIRED_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSCONTENT_ELECTRONIC_ACK_REQUESTED_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSCONTENT_STATUS_CODE_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSCONTENT_ENGINE_INITIAL_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class CD_BARSCONTENT_ENGINE_NUMBER_7 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
