...
{
    public partial class PTC_CD_RCON_2 {
        private PTC_CD_RCONHEADER_2 thisHEADER;
        private PTC_CD_RCONCONTENT_2 thisCONTENT;

        public PTC_CD_RCONHEADER_2 HEADER {
            get { return this.thisHEADER; }
            set { this.thisHEADER = value; }
        }

        public PTC_CD_RCONCONTENT_2 CONTENT {
            get { return this.thisCONTENT; }
            set { this.thisCONTENT = value; }
        }

        public static void createCD_RCON_2(
            ...
            PTC_CD_RCON_2 cD_RCON = new PTC_CD_RCON_2();
            ...
            PTC_CD_RCONCONTENT_2 content = new PTC_CD_RCONCONTENT_2();
            content.SCAC = scac;
            content.SYMBOL = symbol;
            content.SECTION = section;
            content.ORIGIN_DATE = now.ToString("MMddyyyy");

            cD_RCON.HEADER = header;
            cD_RCON.CONTENT = content;

            CD_RCON_2 ptc_cd_rcon = cD_RCON.toSerializableObject();
            fs = File.Create(temp+"/temp.request");
            serializer = new XmlSerializer(typeof(CD_RCON_2));
            var writer = new SteXmlTextWriter(fs);
            serializer.Serialize(writer, ptc_cd_rcon);
            fs.Close();

            request = File.ReadAllText(temp+"/temp.request");
            request = cD_RCON.toSteMessageHeader(request);
            System.IO.File.WriteAllText(SteUtils.getOutboundDir()+SteUtils.getFileName(), request);
        }

        public static void createCD_RCON_2Msmq(
            //string header_event_date, 
            //string header_event_time, 
            //string header_message_id, 
            //string header_sequence_number, 
            ...
            CD_RCON_2 ptc_cd_rcon = cD_RCON.toSerializableObject();
            serializer = new XmlSerializer(typeof(PTC_CD_RCON_2));
            StringWriter writer = new StringWriter();
            serializer.Serialize(writer, ptc_cd_rcon);
            request = cD_RCON.toSteMessageHeader(writer.ToString());
            SteMessageQueue.Instance().Send(request, "PTC_CD-RCON");
        }

        public CD_RCON_2 toSerializableObject() {
            CD_RCON_2 cd_rcon_2 = new CD_RCON_2();
            cd_rcon_2.Items = new object[2];

            CD_RCONHEADER_2 header = new CD_RCONHEADER_2();
            if (this.HEADER != null) {
                if (this.HEADER.HEADER_EVENT_DATE != null) {
                    header.HEADER_EVENT_DATE = new CD_RCONHEADERHEADER_EVENT_DATE_2[1];
                    CD_RCONHEADERHEADER_EVENT_DATE_2 header_event_date = new CD_RCONHEADERHEADER_EVENT_DATE_2();
                ...
                if (this.HEADER.HEADER_EVENT_TIME != null) {
                    header.HEADER_EVENT_TIME = new CD_RCONHEADERHEADER_EVENT_TIME_2[1];
                    CD_RCONHEADERHEADER_EVENT_TIME_2 header_event_time = new CD_RCONHEADERHEADER_EVENT_TIME_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_ID != null) {
                    header.HEADER_MESSAGE_ID = new CD_RCONHEADERHEADER_MESSAGE_ID_2[1];
                    CD_RCONHEADERHEADER_MESSAGE_ID_2 header_message_id = new CD_RCONHEADERHEADER_MESSAGE_ID_2();
                ...
                if (this.HEADER.HEADER_SEQUENCE_NUMBER != null) {
                    header.HEADER_SEQUENCE_NUMBER = new CD_RCONHEADERHEADER_SEQUENCE_NUMBER_2[1];
                    CD_RCONHEADERHEADER_SEQUENCE_NUMBER_2 header_sequence_number = new CD_RCONHEADERHEADER_SEQUENCE_NUMBER_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_VERSION != null) {
                    header.HEADER_MESSAGE_VERSION = new CD_RCONHEADERHEADER_MESSAGE_VERSION_2[1];
                    CD_RCONHEADERHEADER_MESSAGE_VERSION_2 header_message_version = new CD_RCONHEADERHEADER_MESSAGE_VERSION_2();
                ...
                if (this.HEADER.HEADER_MESSAGE_REVISION != null) {
                    header.HEADER_MESSAGE_REVISION = new CD_RCONHEADERHEADER_MESSAGE_REVISION_2[1];
                    CD_RCONHEADERHEADER_MESSAGE_REVISION_2 header_message_revision = new CD_RCONHEADERHEADER_MESSAGE_REVISION_2();
                ...
                if (this.HEADER.HEADER_SOURCE_SYS != null) {
                    header.HEADER_SOURCE_SYS = new CD_RCONHEADERHEADER_SOURCE_SYS_2[1];
                    CD_RCONHEADERHEADER_SOURCE_SYS_2 header_source_sys = new CD_RCONHEADERHEADER_SOURCE_SYS_2();
                ...
                if (this.HEADER.HEADER_DESTINATION_SYS != null) {
                    header.HEADER_DESTINATION_SYS = new CD_RCONHEADERHEADER_DESTINATION_SYS_2[1];
                    CD_RCONHEADERHEADER_DESTINATION_SYS_2 header_destination_sys = new CD_RCONHEADERHEADER_DESTINATION_SYS_2();
                ...
                if (this.HEADER.HEADER_DISTRICT_NAME != null) {
                    header.HEADER_DISTRICT_NAME = new CD_RCONHEADERHEADER_DISTRICT_NAME_2[1];
                    CD_RCONHEADERHEADER_DISTRICT_NAME_2 header_district_name = new CD_RCONHEADERHEADER_DISTRICT_NAME_2();
                ...
                if (this.HEADER.HEADER_DISTRICT_SCAC != null) {
                    header.HEADER_DISTRICT_SCAC = new CD_RCONHEADERHEADER_DISTRICT_SCAC_2[1];
                    CD_RCONHEADERHEADER_DISTRICT_SCAC_2 header_district_scac = new CD_RCONHEADERHEADER_DISTRICT_SCAC_2();
                ...
                if (this.HEADER.HEADER_USER_ID != null) {
                    header.HEADER_USER_ID = new CD_RCONHEADERHEADER_USER_ID_2[1];
                    CD_RCONHEADERHEADER_USER_ID_2 header_user_id = new CD_RCONHEADERHEADER_USER_ID_2();
            ...
            CD_RCONCONTENT_2 content = new CD_RCONCONTENT_2();
            if (this.CONTENT != null) {
                if (this.CONTENT.SCAC != null) {
                    content.SCAC = new CD_RCONCONTENTSCAC_2[1];
                    CD_RCONCONTENTSCAC_2 scac = new CD_RCONCONTENTSCAC_2();
                    scac.Value = this.CONTENT.SCAC;
                    content.SCAC[0] = scac;
                }

                if (this.CONTENT.SYMBOL != null) {
                    content.SYMBOL = new CD_RCONCONTENTSYMBOL_2[1];
                    CD_RCONCONTENTSYMBOL_2 symbol = new CD_RCONCONTENTSYMBOL_2();
                    symbol.Value = this.CONTENT.SYMBOL;
                    content.SYMBOL[0] = symbol;
                }

                if (this.CONTENT.SECTION != null) {
                    content.SECTION = new CD_RCONCONTENTSECTION_2[1];
                    CD_RCONCONTENTSECTION_2 section = new CD_RCONCONTENTSECTION_2();
                    section.Value = this.CONTENT.SECTION;
                    content.SECTION[0] = section;
                }

                if (this.CONTENT.ORIGIN_DATE != null) {
                    content.ORIGIN_DATE = new CD_RCONCONTENTORIGIN_DATE_2[1];
                    CD_RCONCONTENTORIGIN_DATE_2 origin_date = new CD_RCONCONTENTORIGIN_DATE_2();
            ...
            cd_rcon_2.Items[0] = header;
            cd_rcon_2.Items[1] = content;
            return cd_rcon_2;
        }
        ...
        public string toSteMessageHeader(string serializedXml) {
            ...
            string header = "PASSTHRUOTC|CD-RCON|";
    ...
    public partial class PTC_CD_RCONHEADER_2 {
    ...
    public partial class PTC_CD_RCONCONTENT_2 {
    ...
    public partial class CD_RCON_2 {
        private object[] itemsField;

        [System.Xml.Serialization.XmlElementAttribute("HEADER", typeof(CD_RCONHEADER_2), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]

        [System.Xml.Serialization.XmlElementAttribute("CONTENT", typeof(CD_RCONCONTENT_2), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONHEADER_2 {
        private CD_RCONHEADERHEADER_EVENT_DATE_2[] HEADER_EVENT_DATEField;
        private CD_RCONHEADERHEADER_EVENT_TIME_2[] HEADER_EVENT_TIMEField;
        private CD_RCONHEADERHEADER_MESSAGE_ID_2[] HEADER_MESSAGE_IDField;
        private CD_RCONHEADERHEADER_SEQUENCE_NUMBER_2[] HEADER_SEQUENCE_NUMBERField;
        private CD_RCONHEADERHEADER_MESSAGE_VERSION_2[] HEADER_MESSAGE_VERSIONField;
        private CD_RCONHEADERHEADER_MESSAGE_REVISION_2[] HEADER_MESSAGE_REVISIONField;
        private CD_RCONHEADERHEADER_SOURCE_SYS_2[] HEADER_SOURCE_SYSField;
        private CD_RCONHEADERHEADER_DESTINATION_SYS_2[] HEADER_DESTINATION_SYSField;
        private CD_RCONHEADERHEADER_DISTRICT_NAME_2[] HEADER_DISTRICT_NAMEField;
        private CD_RCONHEADERHEADER_DISTRICT_SCAC_2[] HEADER_DISTRICT_SCACField;
        private CD_RCONHEADERHEADER_USER_ID_2[] HEADER_USER_IDField;

        [System.Xml.Serialization.XmlElementAttribute("HEADER_EVENT_DATE", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public CD_RCONHEADERHEADER_EVENT_DATE_2[] HEADER_EVENT_DATE {
        ...
        public CD_RCONHEADERHEADER_EVENT_TIME_2[] HEADER_EVENT_TIME {
        ...
        public CD_RCONHEADERHEADER_MESSAGE_ID_2[] HEADER_MESSAGE_ID {
        ...
        public CD_RCONHEADERHEADER_SEQUENCE_NUMBER_2[] HEADER_SEQUENCE_NUMBER {
        ...
        public CD_RCONHEADERHEADER_MESSAGE_VERSION_2[] HEADER_MESSAGE_VERSION {
        ...
        public CD_RCONHEADERHEADER_MESSAGE_REVISION_2[] HEADER_MESSAGE_REVISION {
        ...
        public CD_RCONHEADERHEADER_SOURCE_SYS_2[] HEADER_SOURCE_SYS {
        ...
        public CD_RCONHEADERHEADER_DESTINATION_SYS_2[] HEADER_DESTINATION_SYS {
        ...
        public CD_RCONHEADERHEADER_DISTRICT_NAME_2[] HEADER_DISTRICT_NAME {
        ...
        public CD_RCONHEADERHEADER_DISTRICT_SCAC_2[] HEADER_DISTRICT_SCAC {
        ...
        public CD_RCONHEADERHEADER_USER_ID_2[] HEADER_USER_ID {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONHEADERHEADER_EVENT_DATE_2 {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONHEADERHEADER_EVENT_TIME_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONHEADERHEADER_MESSAGE_ID_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONHEADERHEADER_SEQUENCE_NUMBER_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONHEADERHEADER_MESSAGE_VERSION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONHEADERHEADER_MESSAGE_REVISION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONHEADERHEADER_SOURCE_SYS_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONHEADERHEADER_DESTINATION_SYS_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONHEADERHEADER_DISTRICT_NAME_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONHEADERHEADER_DISTRICT_SCAC_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONHEADERHEADER_USER_ID_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONCONTENT_2 {
        private CD_RCONCONTENTSCAC_2[] SCACField;
        private CD_RCONCONTENTSYMBOL_2[] SYMBOLField;
        private CD_RCONCONTENTSECTION_2[] SECTIONField;
        private CD_RCONCONTENTORIGIN_DATE_2[] ORIGIN_DATEField;

        [System.Xml.Serialization.XmlElementAttribute("SCAC", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public CD_RCONCONTENTSCAC_2[] SCAC {
        ...
        public CD_RCONCONTENTSYMBOL_2[] SYMBOL {
        ...
        public CD_RCONCONTENTSECTION_2[] SECTION {
        ...
        public CD_RCONCONTENTORIGIN_DATE_2[] ORIGIN_DATE {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONCONTENTSCAC_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONCONTENTSYMBOL_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONCONTENTSECTION_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType=true)]
    public partial class CD_RCONCONTENTORIGIN_DATE_2 {
       	[System.Xml.Serialization.XmlTextAttribute()]
	    public string Value {get; set;}
    }
