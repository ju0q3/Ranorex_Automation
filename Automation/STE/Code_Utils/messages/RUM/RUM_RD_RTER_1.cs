...
{
	public partial class RUM_RD_RTER_1 {
		public RUM_RD_RTERHEADER_1 HEADER;
		public RUM_RD_RTERCONTENT_1 CONTENT;

		public static void createRD_RTER_1(
			...
			RUM_RD_RTER_1 rum_rd_rter = buildRUM_RD_RTER_1(header_event_date, header_event_time, header_sequence_number, header_message_version, header_source_sys, header_destination_sys, header_district_name, header_district_scac, header_user_id, header_division_name, content_request_id, content_pf_addressee, content_pf_addressee_type, content_requesting_employee, content_track_authority_number, content_track_authority_id, content_employee_first, content_employee_middle, content_employee_last, content_req_time_extension, content_ru_comments);

			RD_RTER_1 rd_rter = rum_rd_rter.toSerializableObject();
			fs = File.Create(temp+"/temp.request");
			serializer = new XmlSerializer(typeof(RD_RTER_1));
			var writer = new SteXmlTextWriter(fs);
			serializer.Serialize(writer, rd_rter);
			fs.Close();

			if (hostname == "" || hostname == "Local") {
				string request = File.ReadAllText(temp+"/temp.request");
				request = rum_rd_rter.toSteMessageHeader(request, false);
				System.IO.File.WriteAllText(SteUtils.getOutboundDir()+SteUtils.getFileName(), request);
			} else {
				string request = File.ReadAllText(temp+"/temp.request");
				request = rum_rd_rter.toSteMessageHeader(request, true);
		...
		public static RUM_RD_RTER_1 buildRUM_RD_RTER_1(
			string header_event_date,
			string header_event_time,
			string header_sequence_number,
			string header_message_version,
			...
			RUM_RD_RTER_1 rum_rd_rter = new RUM_RD_RTER_1();

			RUM_RD_RTERHEADER_1 header = new RUM_RD_RTERHEADER_1();
			header.EVENT_DATE = header_event_date;
			header.EVENT_TIME = header_event_time;
			header.MESSAGE_ID = "RD-RTER";
			...
			RUM_RD_RTERCONTENT_1 content = new RUM_RD_RTERCONTENT_1();
			...
			rum_rd_rter.HEADER = header;
			rum_rd_rter.CONTENT = content;
			return rum_rd_rter;
		}

		public RD_RTER_1 toSerializableObject() {
			RD_RTER_1 rd_rter_1 = new RD_RTER_1();
			rd_rter_1.Items = new object[2];

			RD_RTERHEADER_1 header = new RD_RTERHEADER_1();
			if (this.HEADER != null) {
				if (HEADER.EVENT_DATE != "Null") {
					header.EVENT_DATE = new RD_RTERHEADER_EVENT_DATE_1[1];
					header.EVENT_DATE[0] = new RD_RTERHEADER_EVENT_DATE_1();
					header.EVENT_DATE[0].Value = HEADER.EVENT_DATE;
				}

				if (HEADER.EVENT_TIME != "Null") {
					header.EVENT_TIME = new RD_RTERHEADER_EVENT_TIME_1[1];
					header.EVENT_TIME[0] = new RD_RTERHEADER_EVENT_TIME_1();
					header.EVENT_TIME[0].Value = HEADER.EVENT_TIME;
				}

				if (HEADER.MESSAGE_ID != "Null") {
					header.MESSAGE_ID = new RD_RTERHEADER_MESSAGE_ID_1[1];
					header.MESSAGE_ID[0] = new RD_RTERHEADER_MESSAGE_ID_1();
					header.MESSAGE_ID[0].Value = HEADER.MESSAGE_ID;
				}

				if (HEADER.SEQUENCE_NUMBER != "Null") {
					header.SEQUENCE_NUMBER = new RD_RTERHEADER_SEQUENCE_NUMBER_1[1];
					header.SEQUENCE_NUMBER[0] = new RD_RTERHEADER_SEQUENCE_NUMBER_1();
					header.SEQUENCE_NUMBER[0].Value = HEADER.SEQUENCE_NUMBER;
				}

				if (HEADER.MESSAGE_VERSION != "Null") {
					header.MESSAGE_VERSION = new RD_RTERHEADER_MESSAGE_VERSION_1[1];
					header.MESSAGE_VERSION[0] = new RD_RTERHEADER_MESSAGE_VERSION_1();
					header.MESSAGE_VERSION[0].Value = HEADER.MESSAGE_VERSION;
				}

				if (HEADER.SOURCE_SYS != "Null") {
					header.SOURCE_SYS = new RD_RTERHEADER_SOURCE_SYS_1[1];
					header.SOURCE_SYS[0] = new RD_RTERHEADER_SOURCE_SYS_1();
					header.SOURCE_SYS[0].Value = HEADER.SOURCE_SYS;
				}

				if (HEADER.DESTINATION_SYS != "Null") {
					header.DESTINATION_SYS = new RD_RTERHEADER_DESTINATION_SYS_1[1];
					header.DESTINATION_SYS[0] = new RD_RTERHEADER_DESTINATION_SYS_1();
					header.DESTINATION_SYS[0].Value = HEADER.DESTINATION_SYS;
				}

				if (HEADER.DISTRICT_NAME != "Null") {
					header.DISTRICT_NAME = new RD_RTERHEADER_DISTRICT_NAME_1[1];
					header.DISTRICT_NAME[0] = new RD_RTERHEADER_DISTRICT_NAME_1();
					header.DISTRICT_NAME[0].Value = HEADER.DISTRICT_NAME;
				}

				if (HEADER.DISTRICT_SCAC != null && HEADER.DISTRICT_SCAC != "") {
					header.DISTRICT_SCAC = new RD_RTERHEADER_DISTRICT_SCAC_1[1];
					header.DISTRICT_SCAC[0] = new RD_RTERHEADER_DISTRICT_SCAC_1();
				...
				if (HEADER.USER_ID != "Null") {
					header.USER_ID = new RD_RTERHEADER_USER_ID_1[1];
					header.USER_ID[0] = new RD_RTERHEADER_USER_ID_1();
					header.USER_ID[0].Value = HEADER.USER_ID;
				}

				if (HEADER.DIVISION_NAME != "Null") {
					header.DIVISION_NAME = new RD_RTERHEADER_DIVISION_NAME_1[1];
					header.DIVISION_NAME[0] = new RD_RTERHEADER_DIVISION_NAME_1();
					header.DIVISION_NAME[0].Value = HEADER.DIVISION_NAME;
				}

			}

			RD_RTERCONTENT_1 content = new RD_RTERCONTENT_1();
			if (this.CONTENT != null) {
				if (CONTENT.REQUEST_ID != null && CONTENT.REQUEST_ID != "") {
					content.REQUEST_ID = new RD_RTERCONTENT_REQUEST_ID_1[1];
					content.REQUEST_ID[0] = new RD_RTERCONTENT_REQUEST_ID_1();
				...
				if (CONTENT.PF_ADDRESSEE != null && CONTENT.PF_ADDRESSEE != "") {
					content.PF_ADDRESSEE = new RD_RTERCONTENT_PF_ADDRESSEE_1[1];
					content.PF_ADDRESSEE[0] = new RD_RTERCONTENT_PF_ADDRESSEE_1();
				...
				if (CONTENT.PF_ADDRESSEE_TYPE != null && CONTENT.PF_ADDRESSEE_TYPE != "") {
					content.PF_ADDRESSEE_TYPE = new RD_RTERCONTENT_PF_ADDRESSEE_TYPE_1[1];
					content.PF_ADDRESSEE_TYPE[0] = new RD_RTERCONTENT_PF_ADDRESSEE_TYPE_1();
				...
				if (CONTENT.REQUESTING_EMPLOYEE != "Null") {
					content.REQUESTING_EMPLOYEE = new RD_RTERCONTENT_REQUESTING_EMPLOYEE_1[1];
					content.REQUESTING_EMPLOYEE[0] = new RD_RTERCONTENT_REQUESTING_EMPLOYEE_1();
					content.REQUESTING_EMPLOYEE[0].Value = CONTENT.REQUESTING_EMPLOYEE;
				}

				if (CONTENT.TRACK_AUTHORITY_NUMBER != "Null") {
					content.TRACK_AUTHORITY_NUMBER = new RD_RTERCONTENT_TRACK_AUTHORITY_NUMBER_1[1];
					content.TRACK_AUTHORITY_NUMBER[0] = new RD_RTERCONTENT_TRACK_AUTHORITY_NUMBER_1();
					content.TRACK_AUTHORITY_NUMBER[0].Value = CONTENT.TRACK_AUTHORITY_NUMBER;
				}

				if (CONTENT.TRACK_AUTHORITY_ID != "Null") {
					content.TRACK_AUTHORITY_ID = new RD_RTERCONTENT_TRACK_AUTHORITY_ID_1[1];
					content.TRACK_AUTHORITY_ID[0] = new RD_RTERCONTENT_TRACK_AUTHORITY_ID_1();
					content.TRACK_AUTHORITY_ID[0].Value = CONTENT.TRACK_AUTHORITY_ID;
					
				}

				if (CONTENT.EMPLOYEE_FIRST != "Null") {
					content.EMPLOYEE_FIRST = new RD_RTERCONTENT_EMPLOYEE_FIRST_1[1];
					content.EMPLOYEE_FIRST[0] = new RD_RTERCONTENT_EMPLOYEE_FIRST_1();
					content.EMPLOYEE_FIRST[0].Value = CONTENT.EMPLOYEE_FIRST;
				}

				if (CONTENT.EMPLOYEE_MIDDLE != null && CONTENT.EMPLOYEE_MIDDLE != "") {
					content.EMPLOYEE_MIDDLE = new RD_RTERCONTENT_EMPLOYEE_MIDDLE_1[1];
					content.EMPLOYEE_MIDDLE[0] = new RD_RTERCONTENT_EMPLOYEE_MIDDLE_1();
				...
				if (CONTENT.EMPLOYEE_LAST != "Null") {
					content.EMPLOYEE_LAST = new RD_RTERCONTENT_EMPLOYEE_LAST_1[1];
					content.EMPLOYEE_LAST[0] = new RD_RTERCONTENT_EMPLOYEE_LAST_1();
					content.EMPLOYEE_LAST[0].Value = CONTENT.EMPLOYEE_LAST;
				}

				if (CONTENT.REQ_TIME_EXTENSION != null && CONTENT.REQ_TIME_EXTENSION != "") {
					content.REQ_TIME_EXTENSION = new RD_RTERCONTENT_REQ_TIME_EXTENSION_1[1];
					content.REQ_TIME_EXTENSION[0] = new RD_RTERCONTENT_REQ_TIME_EXTENSION_1();
				...
				if (CONTENT.RU_COMMENTS != null && CONTENT.RU_COMMENTS != "") {
					content.RU_COMMENTS = new RD_RTERCONTENT_RU_COMMENTS_1[1];
					content.RU_COMMENTS[0] = new RD_RTERCONTENT_RU_COMMENTS_1();
			...
			rd_rter_1.Items[0] = header;
			rd_rter_1.Items[1] = content;
			return rd_rter_1;
		}
		...
		public string toSteMessageHeader(string serializedXml, bool remote = false) {
			...
			string preScript = "";
			if (!remote) {
				preScript = "PASSTHRUOTC|RD-RTER|";
			} else {
				preScript = "RanorexAgent:PASSTHRUOTC|RD-RTER|";
			}
	...
	public partial class RUM_RD_RTERHEADER_1 {
	...
	public partial class RUM_RD_RTERCONTENT_1 {
	...
	public partial class RD_RTER_1 {
		[System.Xml.Serialization.XmlElementAttribute("HEADER", typeof(RD_RTERHEADER_1), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]

		[System.Xml.Serialization.XmlElementAttribute("CONTENT", typeof(RD_RTERCONTENT_1), Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERHEADER_EVENT_DATE_1 {
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERHEADER_EVENT_TIME_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERHEADER_MESSAGE_ID_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERHEADER_SEQUENCE_NUMBER_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERHEADER_MESSAGE_VERSION_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERHEADER_SOURCE_SYS_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERHEADER_DESTINATION_SYS_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERHEADER_DISTRICT_NAME_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERHEADER_DISTRICT_SCAC_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERHEADER_USER_ID_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERHEADER_DIVISION_NAME_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERCONTENT_REQUEST_ID_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERCONTENT_PF_ADDRESSEE_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERCONTENT_PF_ADDRESSEE_TYPE_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERCONTENT_REQUESTING_EMPLOYEE_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERCONTENT_TRACK_AUTHORITY_NUMBER_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERCONTENT_TRACK_AUTHORITY_ID_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERCONTENT_EMPLOYEE_FIRST_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERCONTENT_EMPLOYEE_MIDDLE_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERCONTENT_EMPLOYEE_LAST_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERCONTENT_REQ_TIME_EXTENSION_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
	...
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	[System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
	public partial class RD_RTERCONTENT_RU_COMMENTS_1 {
		[System.Xml.Serialization.XmlTextAttribute()]
		public string Value;
	}
