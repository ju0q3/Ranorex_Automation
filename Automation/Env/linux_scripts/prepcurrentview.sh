...
verboseEcho "Get Settings" | tee -a C:\\ste\\regression_test\\Test_Label.txt
...
while getopts "v:t:u:s:r:p:d:m:h:" OPTION
   ...
   do
      ...
      case $OPTION in
         ...
         verboseEcho "          ${LABOPT} ... ${OPTARG}" | tee -a C:\\ste\\regression_test\\Test_Label.txt
...
verboseEcho "View Does Not Exist - Create View" | tee -a C:\\ste\\regression_test\\Test_Label.txt



ssh ${USER}@${V_HOST} bash -l -c '"'cmtool mks ${TAG}'"' | tee -a C:\\ste\\regression_test\\Test_Label.txt
...
verboseEcho "Complete" | tee -a C:\\ste\\regression_test\\Test_Label.txt
