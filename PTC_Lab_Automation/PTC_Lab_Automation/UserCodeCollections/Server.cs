...
namespace PTC_Lab_Automation.UserCodeCollections
{
    ...
    public class Server
    {
        ...
        [UserCodeMethod]
        public static void SendCommandToSTE(string functionalArea, string command, string pipeSeparatedParameters)
        {
            SendCommandToClient(functionalArea, command, pipeSeparatedParameters, "STE");
        }
        ...
        public static void SendCommandToClient(string functionalArea, string command, string pipeSeparatedParameters, string clientName)
        {
            ...
            string onBoardMessage = string.Join("&", new List<string>{functionalArea, command, pipeSeparatedParameters});
